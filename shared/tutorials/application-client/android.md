...
<div class="grid-50"><p style="text-align: center;"><img src="/assets/images/platform/tutorials/application-client/join-android.png" loading="lazy" style="width: 50%;" alt="Join screen of the Android tutorial app"/></p></div>

<div class="grid-50"><p style="text-align: center;"><img src="/assets/images/platform/tutorials/application-client/room-android.png" loading="lazy" style="width: 50%;" alt="Video call room of the Android tutorial app"/></p></div>
