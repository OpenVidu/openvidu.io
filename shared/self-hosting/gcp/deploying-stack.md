...
!!! warning
    ...
    ![Google Cloud Platform input variables](/assets/images/platform/self-hosting/shared/gcp/cloud-build-logs.png){ .round-corners .dark-img loading=lazy }
...
=== "Check deployment outputs in the instance"
    ...
    ![Google Cloud Platform gcloud command](/assets/images/platform/self-hosting/shared/gcp/gcloud-command.png){ .round-corners .dark-img loading=lazy }
