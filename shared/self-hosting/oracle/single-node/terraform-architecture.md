...
=== "Architecture overview"
    ...
    ![OpenVidu Single Node Oracle Cloud Infrastructure Architecture](/assets/images/platform/self-hosting/single-node/oracle/single-node-architecture.svg){ .dark-img loading=lazy }
