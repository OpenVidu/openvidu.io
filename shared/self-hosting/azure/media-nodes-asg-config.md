=== "Media Nodes Virtual Machine Scale Set (VMSS) Configuration"
    ...
    ![Media Nodes Virtual Machine Scale Set (VMSS) Configuration](/assets/images/platform/self-hosting/shared/azure/media-nodes-asg-config.png){ .round-corners loading=lazy }
