...
![Azure Instance configuration](/assets/images/platform/self-hosting/shared/azure/stack-resource-group.png){ .svg-img .dark-img loading=lazy }
...
![Azure Instance configuration](/assets/images/platform/self-hosting/shared/azure/stack-name-region.png){ .svg-img .dark-img loading=lazy }