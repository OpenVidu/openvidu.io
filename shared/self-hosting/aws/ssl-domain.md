...
=== "Let's Encrypt Without Domain Name"
    ...
    ![Let's Encrypt certificates](/assets/images/platform/self-hosting/shared/aws/letsencrypt-nodomain.png){ .round-corners loading=lazy }
...
=== "Let's Encrypt With Domain Name (recommended)"
    ...
    ![Let's Encrypt certificates](/assets/images/platform/self-hosting/shared/aws/letsencrypt.png){ .round-corners loading=lazy }
...
=== "Custom Certificates"
    ...
    ![Custom certificates](/assets/images/platform/self-hosting/shared/aws/owncert.png){ .round-corners loading=lazy }
...
=== "Self-Signed Certificate"
    ...
    ![Self-signed certificates](/assets/images/platform/self-hosting/shared/aws/selfsigned.png){ .round-corners loading=lazy }
