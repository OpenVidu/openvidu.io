=== "Stop OpenVidu Single Node"
    ...
    ![Stop instance](/assets/images/platform/self-hosting/single-node/aws/stop-instance.png){ .svg-img .dark-img loading=lazy }
...
=== "Start OpenVidu Single Node"
    ...
    ![Start instance](/assets/images/platform/self-hosting/single-node/aws/start-instance.png){ .svg-img .dark-img loading=lazy }
