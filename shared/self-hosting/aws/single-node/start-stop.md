=== "Stop OpenVidu Single Node"
    ...
    <figure markdown>
    ![Stop instance](/assets/images/platform/self-hosting/single-node/aws/stop-instance.png){ .svg-img .dark-img }
    </figure>
...
=== "Start OpenVidu Single Node"
    ...
    <figure markdown>
    ![Start instance](/assets/images/platform/self-hosting/single-node/aws/start-instance.png){ .svg-img .dark-img }
    </figure>
