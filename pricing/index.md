...
Users must create an [OpenVidu account](https://openvidu.io/account/index.md) and get an OpenVidu License. This license will be required to deploy an OpenVidu Pro cluster ([OpenVidu Elastic](https://openvidu.io/latest/docs/self-hosting/elastic/index.md) or [OpenVidu High Availability](https://openvidu.io/latest/docs/self-hosting/ha/index.md)).
