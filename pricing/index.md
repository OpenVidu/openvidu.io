...
| Type of deployment        | [**OpenVidu Single NodeCOMMUNITY**](https://openvidu.io/docs/self-hosting/deployment-types/#openvidu-single-node) | [**OpenVidu Single Node PRO**](https://openvidu.io/docs/self-hosting/deployment-types/#openvidu-single-node) | [**OpenVidu Elastic**](https://openvidu.io/docs/self-hosting/deployment-types/#openvidu-elastic) | [**OpenVidu High Availability**](https://openvidu.io/docs/self-hosting/deployment-types/#openvidu-high-availability) |
...
| Installation instructions | [Install](https://openvidu.io/docs/self-hosting/single-node)                                                      | [Install](https://openvidu.io/docs/self-hosting/single-node-pro)                                             | [Install](https://openvidu.io/docs/self-hosting/elastic/index.md)                                | [Install](https://openvidu.io/docs/self-hosting/ha/index.md)                                                         |
...
Users must create an [OpenVidu account](/account/) and get an OpenVidu License. This license will be required to deploy an OpenVidu Pro cluster ([OpenVidu Elastic](https://openvidu.io/docs/self-hosting/elastic/index.md) or [OpenVidu High Availability](https://openvidu.io/docs/self-hosting/ha/index.md)).
