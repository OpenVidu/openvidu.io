...
You can automate the room creation process by using the [OpenVidu Meet REST API](https://openvidu.io/3.5.0/meet/embedded/reference/rest-api/index.md). This allows you to create rooms programmatically from your application's backend, without manual intervention.

Check out the [API reference for creating rooms](https://openvidu.io/3.5.0/meet/embedded/reference/api.html#/operations/createRoom) . Below you have copy-paste snippets for most common languages.
...
You can get the room URLs programmatically using the [OpenVidu Meet REST API](https://openvidu.io/3.5.0/meet/embedded/reference/rest-api/index.md). They are available in properties `moderatorUrl` and `speakerUrl` of object [MeetRoom](https://openvidu.io/3.5.0/meet/embedded/reference/api.html#/schemas/MeetRoom) . This object is returned as a JSON response from methods:

- [Create a room](https://openvidu.io/3.5.0/meet/embedded/reference/api.html#/operations/createRoom)
- [Get a room](https://openvidu.io/3.5.0/meet/embedded/reference/api.html#/operations/getRoom)
- [Get all rooms](https://openvidu.io/3.5.0/meet/embedded/reference/api.html#/operations/getRooms)
...
\[[](../../../assets/videos/meet/embed-url.mp4)\](https://openvidu.io/3.5.0/assets/videos/meet/embed-url.mp4)
...
See [Passing attributes to a direct link](https://openvidu.io/3.5.0/meet/embedded/reference/direct-link/#attributes) for more information.
...
Check out the [Web Component reference](https://openvidu.io/3.5.0/meet/embedded/reference/webcomponent/index.md) for the complete list of attributes, commands and events offered by it.
...
- [Pass attributes to an OpenVidu Meet iframe](https://openvidu.io/3.5.0/meet/embedded/reference/iframe/#attributes)
- [Send commands to an OpenVidu Meet iframe](https://openvidu.io/3.5.0/meet/embedded/reference/iframe/#commands)
- [Receive events from an OpenVidu Meet iframe](https://openvidu.io/3.5.0/meet/embedded/reference/iframe/#events)
...
Checkout the Web Component's [attributes](https://openvidu.io/3.5.0/meet/embedded/reference/webcomponent/#attributes) section for more information.
...
- [OpenVidu Meet console](https://openvidu.io/3.5.0/meet/features/recordings/#sharing-recordings-via-link)
- [Programmatically via REST API](https://openvidu.io/3.5.0/meet/embedded/reference/api.html#/operations/getRecordingUrl)
...
- [REST API](https://openvidu.io/3.5.0/meet/embedded/reference/rest-api/index.md): manage rooms and recordings programmatically.
- [Webhooks](https://openvidu.io/3.5.0/meet/embedded/reference/webhooks/index.md): listen to events happening in real time.
