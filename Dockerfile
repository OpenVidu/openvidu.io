...
RUN pip install mkdocs==1.6.1 pymdown-extensions==12.0.1 mkdocs-glightbox==0.5.2 mkdocs-llmstxt==0.5.0 mkdocs-rss-plugin==1.19.0 pygments==2.21.0 gitpython==3.1.62
