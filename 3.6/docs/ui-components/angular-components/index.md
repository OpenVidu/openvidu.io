...
You can check out all component events in the [Angular Components API Reference](https://openvidu.io/3.6/docs/reference-docs/openvidu-components-angular/).
...
- [Angular Components API Reference](https://openvidu.io/3.6/docs/reference-docs/openvidu-components-angular/)
