...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.6.1/application-server/node)
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-server/node/index.js#L1-L14)
...
It also initializes the `WebhookReceiver` object that will help validating and decoding incoming [webhook events](https://docs.livekit.io/intro/basics/rooms-participants-tracks/webhooks-events/) .
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-server/node/index.js#L16-L31)
...
1. We set the video grants in the AccessToken. `roomJoin` allows the user to join a room and `room` determines the specific room. Check out all [Video Grants](https://docs.livekit.io/frontends/reference/tokens-grants/#video-grant) .
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-server/node/index.js#L33-L49)
