...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.6.1/application-server/java)

This is a minimal server application built for Java with [Spring Boot](https://spring.io/) that allows:

- Generating LiveKit tokens on demand for any [application client](https://openvidu.io/3.6/docs/tutorials/application-client/index.md).
- Receiving LiveKit [webhook events](https://docs.livekit.io/intro/basics/rooms-participants-tracks/webhooks-events/) .
...
For more information, check the [JavaScript tutorial](https://openvidu.io/3.6/docs/tutorials/application-client/javascript/index.md).
...
For more information, check the [React tutorial](https://openvidu.io/3.6/docs/tutorials/application-client/react/index.md).
...
For more information, check the [Angular tutorial](https://openvidu.io/3.6/docs/tutorials/application-client/angular/index.md).
...
For more information, check the [Vue tutorial](https://openvidu.io/3.6/docs/tutorials/application-client/vue/index.md).
...
>
> One advantage of [running OpenVidu locally](#run-openvidu-locally) is that you can test your application client with other devices in your local network very easily without worrying about SSL certificates. For more information, see section [Accessing your local deployment from other devices on your network](https://openvidu.io/3.6/docs/self-hosting/local/#accessing-your-local-deployment-from-other-devices-on-your-network).

For more information, check the [Electron tutorial](https://openvidu.io/3.6/docs/tutorials/application-client/electron/index.md).
...
1. Serve the application:
   ...
   **Mobile**
   ...
   If you run [OpenVidu locally](#run-openvidu-locally) you don't need to worry about this. OpenVidu will handle all of the above requirements for you. For more information, see section [Accessing your local deployment from other devices on your network](https://openvidu.io/3.6/docs/self-hosting/local/#accessing-your-local-deployment-from-other-devices-on-your-network).
...
For more information, check the [Ionic tutorial](https://openvidu.io/3.6/docs/tutorials/application-client/ionic/index.md).
...
For more information, check the [Android tutorial](https://openvidu.io/3.6/docs/tutorials/application-client/android/index.md).
...
For more information, check the [iOS tutorial](https://openvidu.io/3.6/docs/tutorials/application-client/ios/index.md).
...
[Controller.java](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L19-L27)
...
[Controller.java](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L33-L48)
...
1. We set the video grants in the AccessToken. `RoomJoin` allows the user to join a room and `RoomName` determines the specific room. Check out all [Video Grants](https://docs.livekit.io/frontends/reference/tokens-grants/#video-grant) .
...
The endpoint `/livekit/webhook` accepts `POST` requests with a payload of type `application/webhook+json`. This is the endpoint where LiveKit Server will send [webhook events](https://docs.livekit.io/intro/basics/rooms-participants-tracks/webhooks-events/#webhook-events) .

[Controller.java](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L50-L60)
...
1. Initialize the WebhookReceiver using the `LIVEKIT_API_KEY` and `LIVEKIT_API_SECRET`. It will help validating and decoding incoming [webhook events](https://docs.livekit.io/intro/basics/rooms-participants-tracks/webhooks-events/) .
