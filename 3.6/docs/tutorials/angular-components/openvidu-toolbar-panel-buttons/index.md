...
[Source code](https://github.com/OpenVidu/openvidu-tutorials/tree/3.6.1/openvidu-components-angular/openvidu-toolbar-panel-buttons)
...
1. `onButtonClicked` method that fires when the custom button is clicked.
