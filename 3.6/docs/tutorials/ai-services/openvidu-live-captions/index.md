...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.6.1/ai-services/openvidu-live-captions)

This tutorial is a simple variation of the [JavaScript client](https://openvidu.io/3.6/docs/tutorials/application-client/javascript/index.md) tutorial, adding **live captions** thanks to the use of OpenVidu [Live Captions service](https://openvidu.io/3.6/docs/ai/live-captions/index.md).
...
1. Enable the Speech Processing agent:
   ...
   Modify file [`openvidu-local-deployment/community/agent-speech-processing.yaml`](https://github.com/OpenVidu/openvidu-local-deployment/blob/3.6.1/community/agent-speech-processing.yaml) to enable the Speech Processing agent. At least you need to set the following properties:
   ...
   > Visit [**Supported AI providers**](https://openvidu.io/3.6/docs/ai/live-captions/#supported-ai-providers) to see the full list of available AI providers, both local and cloud-based.
...
>
> Once your deployment is up and running, enable the Live Captions service following the [official instructions](https://openvidu.io/3.6/docs/ai/live-captions/#how-to-enable-live-captions-service-in-your-openvidu-deployment).
...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/ai-services/openvidu-live-captions/src/app.js#L60-L74)
...
1. Read attribute `lk.transcription_final` to determine if the transcription message is a final or an interim one. See [Final vs Interim transcriptions](https://openvidu.io/3.6/docs/ai/live-captions/#final-vs-interim-transcriptions).
...
- `lk.transcription_final`: Indicates whether the transcription message is final or interim. See [Final vs Interim transcriptions](https://openvidu.io/3.6/docs/ai/live-captions/#final-vs-interim-transcriptions) for more details.
