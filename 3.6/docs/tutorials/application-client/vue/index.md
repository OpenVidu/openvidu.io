...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.6.1/application-client/openvidu-vue)
...
[App.vue](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-vue/src/App.vue#L14-L50)
...
[App.vue](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-vue/src/App.vue#L52-L90)
...
1. It requests a token from the application server using the room name and participant name. This is done by calling the `getToken()` function:
   ...
   [App.vue](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-vue/src/App.vue#L109-L141)
...
[App.vue](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-vue/src/App.vue#L168-L183)
...
[VideoComponent.vue](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-vue/src/components/VideoComponent.vue#L5-L26)
...
[AudioComponent.vue](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-vue/src/components/AudioComponent.vue#L5-L18)
...
[App.vue](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-vue/src/App.vue#L92-L107)
