...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-electron/src/app.js#L1-L7)
...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-electron/src/app.js#L9-L57)
...
1. Event handling is configured for different scenarios within the room. These events are fired when new tracks are subscribed to and when existing tracks are unsubscribed.
   ...
   [app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-electron/src/app.js#L59-L72)
   ...
   [app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-electron/src/app.js#L101-L121)
   ...
   [app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-electron/src/app.js#L123-L126)
...
1. It requests a token from the application server using the room name and participant name. This is done by calling the `getToken()` function:
   ...
   [app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-electron/src/app.js#L135-L167)
...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-electron/src/app.js#L74-L92)
