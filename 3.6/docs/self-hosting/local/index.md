...
You just need to point your OpenVidu and LiveKit applications to `http://localhost:7880` or `ws://localhost:7880` and start developing. Check our [tutorials](https://openvidu.io/3.6/docs/tutorials/application-client/index.md) if you want a step-by-step guide to develop your first application using OpenVidu.
...
For production, you should consider deploying a [production-grade OpenVidu deployment](https://openvidu.io/3.6/docs/self-hosting/deployment-types/#openvidu-single-node).
