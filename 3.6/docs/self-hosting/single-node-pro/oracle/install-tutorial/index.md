...
The [minimum inbound ports to allow](https://openvidu.io/3.6/docs/self-hosting/single-node-pro/on-premises/install/#port-rules) must be included in the NSG rules.
...
1. Follow the [On-Premises install instructions](https://openvidu.io/3.6/docs/self-hosting/single-node-pro/on-premises/install/index.md) to install OpenVidu PRO on the instance.
...
- To upgrade OpenVidu PRO, see the [On-Premises upgrade section](https://openvidu.io/3.6/docs/self-hosting/single-node-pro/on-premises/upgrade/index.md).
