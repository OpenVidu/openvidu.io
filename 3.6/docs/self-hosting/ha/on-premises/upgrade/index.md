...
1. SSH into your Master Nodes and your Media Nodes and execute on each of them the following command:
...
1. Answer `Yes` to the question and your OpenVidu will be upgraded to the asked version.
