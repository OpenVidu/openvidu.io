...
1. Copy **terraform.tfvars.example** to **terraform.tfvars**, update the required parameters with your values, and optionally adjust defaults.
   ...
   > | `fixedNumberOfMediaNodes`  | `4`             | Fixed number of Media Nodes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
When your **OPENVIDU_URL** is reachable, it means that everything has gone well. Now you can check the [Administration](https://openvidu.io/3.6/docs/self-hosting/ha/digitalocean/admin/index.md) section to learn how to manage your deployment.
