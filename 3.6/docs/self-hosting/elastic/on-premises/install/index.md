...
Once you have OpenVidu deployed, you can check the [Administration](https://openvidu.io/3.6/docs/self-hosting/elastic/on-premises/admin/index.md) section to learn how to manage your OpenVidu Elastic deployment.
