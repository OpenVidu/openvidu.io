...
This section describes how to deploy a production-ready OpenVidu Elastic instance on Google Cloud Platform. The deployed services are identical to those in the [On Premises Elastic installation](https://openvidu.io/3.6/docs/self-hosting/elastic/on-premises/install/index.md), but are provisioned as Google Cloud Platform resources and can be automated through the Google Cloud Console.
...
- For the **Git ref**, use `v3.6.1`, corresponding to the version you want to deploy.
