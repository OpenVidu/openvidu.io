...
This section describes how to deploy a production-ready OpenVidu Elastic instance on Azure. The deployed services are identical to those in the [On Premises Elastic installation](https://openvidu.io/3.6/docs/self-hosting/elastic/on-premises/install/index.md), but are provisioned as Azure resources and can be automated through an ARM Template Spec.
