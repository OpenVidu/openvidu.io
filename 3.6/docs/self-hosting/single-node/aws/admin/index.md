...
For administration, you can follow the instructions from the [On Premises Single Node Administration](https://openvidu.io/3.6/docs/self-hosting/single-node/on-premises/admin/index.md) section.
