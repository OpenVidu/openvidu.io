...
The [minimum inbound ports to allow](https://openvidu.io/3.6/docs/self-hosting/single-node/on-premises/install/#port-rules) must be included in the NSG rules.
