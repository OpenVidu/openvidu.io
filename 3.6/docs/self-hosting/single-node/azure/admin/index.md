...
1. In the section of the Virtual Machine click on stop button to stop the Virtual Machine (and therefore OpenVidu).
...
Regarding the administration of your deployment, you can follow the instructions in section [On Premises Single Node Administration](https://openvidu.io/3.6/docs/self-hosting/single-node/on-premises/admin/index.md).
