...
| **Installation instructions** | [Install](https://openvidu.io/3.6/docs/self-hosting/local/index.md)                                                                                                   | [Install](https://openvidu.io/3.6/docs/self-hosting/single-node/index.md)                                                                                                        | [Install](https://openvidu.io/3.6/docs/self-hosting/elastic/index.md)                                         | [Install](https://openvidu.io/3.6/docs/self-hosting/ha/index.md)         |
...
| **Agents**                     | Modules used to add AI capabilities to Rooms. See [AI Services](https://openvidu.io/3.6/docs/ai/overview/index.md).                                                     |
