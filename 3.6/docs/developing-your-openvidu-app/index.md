...
The quickest way is to use [OpenVidu local deployment](https://openvidu.io/3.6/docs/self-hosting/local/index.md).

If you feel like it, you can directly launch a production-ready deployment on **AWS**, **Azure** or **your own servers**. Check out the different options at [Deployment types](https://openvidu.io/3.6/docs/self-hosting/deployment-types/index.md).
...
[Node.js Tutorial](https://openvidu.io/3.6/docs/tutorials/application-server/node/index.md)

[Reference Docs](https://docs.livekit.io/reference/server-sdk-js/)

**Go**

[Go Tutorial](https://openvidu.io/3.6/docs/tutorials/application-server/go/index.md)

[Reference Docs](https://pkg.go.dev/github.com/livekit/server-sdk-go)

**Ruby**

[Ruby Tutorial](https://openvidu.io/3.6/docs/tutorials/application-server/ruby/index.md)

[GitHub Repository](https://github.com/livekit/server-sdk-ruby)

**Java**

[Java Tutorial](https://openvidu.io/3.6/docs/tutorials/application-server/java/index.md)

[GitHub Repository](https://github.com/livekit/server-sdk-kotlin)

**Python**

[Python Tutorial](https://openvidu.io/3.6/docs/tutorials/application-server/python/index.md)

[GitHub Repository](https://github.com/livekit/python-sdks)

**Rust**

[Rust Tutorial](https://openvidu.io/3.6/docs/tutorials/application-server/rust/index.md)

[Reference Docs](https://docs.rs/livekit-api/latest/livekit_api/index.html)

**PHP**

[PHP Tutorial](https://openvidu.io/3.6/docs/tutorials/application-server/php/index.md)

[GitHub Repository](https://github.com/agence104/livekit-server-sdk-php)

**.NET**

[.NET Tutorial](https://openvidu.io/3.6/docs/tutorials/application-server/dotnet/index.md)
...
- **Use a high-level UI Components library**: you can use [Angular Components](https://openvidu.io/3.6/docs/ui-components/angular-components/index.md) and [React Components](https://openvidu.io/3.6/docs/ui-components/react-components/index.md) to quickly set up your UI with building blocks that manage the events and state of the Room for you.
...
| **Tutorials**   | [Angular Components tutorials](https://openvidu.io/3.6/docs/tutorials/angular-components/index.md)                                                                                                                                                                                         | [Application client tutorials](https://openvidu.io/3.6/docs/tutorials/application-client/index.md)                                                                             |
...
[**JavaScript**](https://openvidu.io/3.6/docs/tutorials/application-client/javascript/index.md)

[**React**](https://openvidu.io/3.6/docs/tutorials/application-client/react/index.md)

[**Angular**](https://openvidu.io/3.6/docs/tutorials/application-client/angular/index.md)

[**Vue**](https://openvidu.io/3.6/docs/tutorials/application-client/vue/index.md)

[**Electron**](https://openvidu.io/3.6/docs/tutorials/application-client/electron/index.md)

[**Ionic**](https://openvidu.io/3.6/docs/tutorials/application-client/ionic/index.md)

[**Android**](https://openvidu.io/3.6/docs/tutorials/application-client/android/index.md)

[**iOS**](https://openvidu.io/3.6/docs/tutorials/application-client/ios/index.md)

## 4. Deploy OpenVidu and your application

You have different options to deploy OpenVidu in a production-ready environment, depending on the level of scalability, fault tolerance and observability you need. See [Deployment types](https://openvidu.io/3.6/docs/self-hosting/deployment-types/index.md) for more information.
