...
OpenVidu Meet is under the hood an OpenVidu Platform deployment, so you can refer to the [OpenVidu Platform Single Node administration guide](https://openvidu.io/3.6/docs/self-hosting/single-node/on-premises/admin/) for more advanced management tasks, including:
...
- [Upgrade OpenVidu Meet to a newer version](https://openvidu.io/3.6/docs/self-hosting/single-node/on-premises/upgrade/)
...
- **Deploy OpenVidu Meet single-node in AWS**: using our CloudFormation template, you can deploy OpenVidu Meet using native AWS resources. Follow the [AWS deployment](https://openvidu.io/3.6/docs/self-hosting/single-node/aws/install/) guide for OpenVidu Platform.

- **Deploy OpenVidu Meet single-node in Azure**: using our ARM template, you can deploy OpenVidu Meet using native Azure resources. Follow the [Azure deployment](https://openvidu.io/3.6/docs/self-hosting/single-node/azure/install/) guide for OpenVidu Platform.

- **Deploy OpenVidu Meet single-node in GCP**: using our Terraform template, you can deploy OpenVidu Meet using native GCP resources. Follow the [GCP deployment](https://openvidu.io/3.6/docs/self-hosting/single-node/gcp/install/) guide for OpenVidu Platform.
