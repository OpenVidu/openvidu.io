...
Recordings must be started by a participant with role "Moderator" in the meeting view (see [Participant roles in a room](https://openvidu.io/3.6/meet/features/users-and-permissions/#participant-roles-in-a-room)).

\[[](../../../assets/videos/meet/start-recording.mp4)\](https://openvidu.io/3.6/assets/videos/meet/start-recording.mp4)
...
\[[](../../../assets/videos/meet/recording-while-meeting.mp4)\](https://openvidu.io/3.6/assets/videos/meet/recording-while-meeting.mp4)
...
- Users can generate a shareable link from the recording list.
  ...
  \[[](../../../assets/videos/meet/share-recording-from-recording-list.mp4)\](https://openvidu.io/3.6/assets/videos/meet/share-recording-from-recording-list.mp4)

- Users can generate a shareable link from the recording view.

  \[[](../../../assets/videos/meet/share-recording.mp4)\](https://openvidu.io/3.6/assets/videos/meet/share-recording.mp4)

- From OpenVidu Meet console it is possible to generate shareable links for any recording.

  \[[](../../../assets/videos/meet/meet-recording-share-dark.mp4)\](https://openvidu.io/3.6/assets/videos/meet/meet-recording-share-dark.mp4)

## Room recording settings

Rooms can be configured with different recording settings. You can set up these settings when [creating a new room](https://openvidu.io/3.6/meet/features/rooms-and-meetings/#creating-a-room) or [editing an existing room](https://openvidu.io/3.6/meet/features/rooms-and-meetings/#editing-a-room).
...
Recordings can be managed via the [OpenVidu Meet REST API](https://openvidu.io/3.6/meet/embedded/reference/rest-api/index.md):

| Operation              | HTTP Method | Reference                                                                                              |
| ---------------------- | ----------- | ------------------------------------------------------------------------------------------------------ |
| Get recording          | GET         | [Reference](https://openvidu.io/3.6/meet/embedded/reference/api.html#/operations/getRecording)         |
| Get all recordings     | GET         | [Reference](https://openvidu.io/3.6/meet/embedded/reference/api.html#/operations/getRecordings)        |
| Delete recording       | DELETE      | [Reference](https://openvidu.io/3.6/meet/embedded/reference/api.html#/operations/deleteRecording)      |
| Bulk delete recordings | DELETE      | [Reference](https://openvidu.io/3.6/meet/embedded/reference/api.html#/operations/bulkDeleteRecordings) |
| Download recordings    | GET         | [Reference](https://openvidu.io/3.6/meet/embedded/reference/api.html#/operations/downloadRecordings)   |
| Get recording media    | GET         | [Reference](https://openvidu.io/3.6/meet/embedded/reference/api.html#/operations/getRecordingMedia)    |
| Get recording URL      | GET         | [Reference](https://openvidu.io/3.6/meet/embedded/reference/api.html#/operations/getRecordingUrl)      |
