...
You can get a room's URL programmatically from your application's backend: properties `moderatorUrl` and `speakerUrl` of object [MeetRoom](https://openvidu.io/3.6/meet/embedded/reference/api.html#/schemas/MeetRoom) .
