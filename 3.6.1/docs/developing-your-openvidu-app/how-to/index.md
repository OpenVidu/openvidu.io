...
Every application server tutorial here is ready to receive webhooks: [Application Server Tutorials](https://openvidu.io/3.6.1/docs/tutorials/application-server/index.md).
