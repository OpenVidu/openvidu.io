...
The extent of fault tolerance depends on the [OpenVidu deployment type](https://openvidu.io/3.6.1/docs/self-hosting/deployment-types/index.md):
...
In the event of a Media Node failure, there are [3 services](https://openvidu.io/3.6.1/docs/self-hosting/deployment-types/#media-node-services) affected with the following behaviors:
...
OpenVidu High Availability delivers the highest possible degree of fault tolerance. This is achieved by running all of the [services in the Master Nodes and the Media Nodes](https://openvidu.io/3.6.1/docs/self-hosting/deployment-types/#node-services) in their **High Availability** flavour.
