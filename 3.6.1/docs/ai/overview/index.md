...
[List of provided AI services](#speech-processing-agent) [Enable the agent](https://openvidu.io/3.6.1/docs/ai/openvidu-agents/speech-processing-agent/index.md)
...
- **Live Captions**
  ...
  [Go to Live Captions](https://openvidu.io/3.6.1/docs/ai/live-captions/index.md)
