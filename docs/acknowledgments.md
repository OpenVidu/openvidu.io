...
![Sponsor Ministry of Economy](assets/images/sponsors/footer-ministerio-economia-400-optimized.png){style="width: 40%; min-width: 360px" .skip-gallery}
![Sponsor European Union](assets/images/sponsors/footer-european-union-400-optimized.png){style="width: 40%; min-width: 360px" .skip-gallery}
![Sponsor Comunidad de Madrid](assets/images/sponsors/comunidaddemadrid-light.svg#only-light){style="width: 12%; min-width: 100px" .skip-gallery}
![Sponsor Comunidad de Madrid](assets/images/sponsors/comunidaddemadrid-dark.svg#only-dark){style="width: 12%; min-width: 100px" .skip-gallery}
...
![Sponsor NewGenVidu](assets/images/sponsors/support.jpg){style="width: 25%; min-width: 360px" .skip-gallery}
/// caption
///