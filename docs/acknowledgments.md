...
![Sponsor Ministry of Economy](assets/images/sponsors/footer-ministerio-economia-400-optimized.png){ .round-corners style="width: 40%; min-width: 360px" .skip-gallery loading=lazy }
![Sponsor European Union](assets/images/sponsors/footer-european-union-400-optimized.png){ .round-corners style="width: 40%; min-width: 360px" .skip-gallery loading=lazy }
![Sponsor Comunidad de Madrid](assets/images/sponsors/comunidaddemadrid-light.svg#only-light){style="width: 12%; min-width: 100px" .skip-gallery loading=lazy }
![Sponsor Comunidad de Madrid](assets/images/sponsors/comunidaddemadrid-dark.svg#only-dark){style="width: 12%; min-width: 100px" .skip-gallery loading=lazy }
...
![Sponsor NewGenVidu](assets/images/sponsors/support.jpg){ .round-corners style="width: 25%; min-width: 360px" .skip-gallery loading=lazy }
/// caption
///