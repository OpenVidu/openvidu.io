...
- [Meeting lifecycle](lifecycle.md) — the series of views a room member moves through, from opening a room access link until the meeting ends: Join, Device, Meeting, Recordings and End.
