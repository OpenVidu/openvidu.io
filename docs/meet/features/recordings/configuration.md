...
description: Configure recording layouts and resolution in OpenVidu Meet.
tags:
  - setupcustomgallery
---
...
OpenVidu Meet provides multiple **recording layout options** that can be configured when [creating a new room](../rooms/creation-management.md#create-rooms). These layouts determine how participants appear in the meeting recording, allowing you to choose the most suitable format for presentations, webinars, or collaborative sessions.
...
OpenVidu Meet records meetings at a configurable resolution that balances quality and storage size.

!!! info "Documentation coming soon"
    Detailed documentation about supported recording resolutions and how to configure them per room is on the way.
