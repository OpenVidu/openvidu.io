...
Recordings are always associated with the [room](../rooms/overview.md) where they were generated. Who can retrieve and delete them is governed by [room member permissions](#recording-permissions), and they can be opened both from within the room and from the global "Recordings" page of the OpenVidu Meet app.
...
## Recording permissions { #recording-permissions }
