---
title: Recording layouts in OpenVidu Meet
description: Available layouts for OpenVidu Meet recordings — grid, speaker and single speaker.
tags:
  - setupcustomgallery
---
...
OpenVidu Meet provides multiple **recording layout options** that can be configured when [creating a new room](../rooms/create.md). These layouts determine how participants appear in the meeting recording, allowing you to choose the most suitable format for presentations, webinars, or collaborative sessions.
