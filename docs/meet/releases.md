...
Nothing was added in this release in OpenVidu Meet. You can learn more about the core internal improvements introduced by the OpenVidu Platform here: [OpenVidu Platform 3.7.0 :fontawesome-solid-external-link:{.external-link-icon}](https://openvidu.io/3.7/docs/releases/#370){:target="_blank" .platform-link-color}

## 3.6.0

!!! info "For the Release Notes of OpenVidu Platform 3.6.0, please visit here: [OpenVidu Platform 3.6.0 :fontawesome-solid-external-link:{.external-link-icon}](https://openvidu.io/3.6/docs/releases/#360){:target="_blank" .platform-link-color}"
...
!!! info "For the Release Notes of OpenVidu Platform 3.5.0, please visit here: [OpenVidu Platform 3.5.0 :fontawesome-solid-external-link:{.external-link-icon}](https://openvidu.io/3.5/docs/releases/#350){:target="_blank" .platform-link-color}"
...
!!! info "For the Release Notes of OpenVidu Platform 3.4.0, please visit here: [OpenVidu Platform 3.4.0 :fontawesome-solid-external-link:{.external-link-icon}](https://openvidu.io/3.4/docs/releases/#340){:target="_blank" .platform-link-color}"
