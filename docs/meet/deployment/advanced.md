...
!!! info "You can install OpenVidu Meet as a Single Node deployment by following the [basic deployment guide](./basic.md). You can also checkout the [OpenVidu Platform documentation](../../docs/self-hosting/single-node/index.md) for more detailed installation options."
