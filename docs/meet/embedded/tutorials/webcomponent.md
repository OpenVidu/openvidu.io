...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-meet-tutorials/tree/3.6.1/meet-webcomponent-basic){ .md-button target=\_blank }
...
```html title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.6.1/meet-webcomponent-basic/public/index.html#L66-L67' target='_blank'>index.html</a>" linenums="66"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.6.1/meet-webcomponent-basic/public/js/app.js#L48-L75' target='_blank'>app.js</a>" linenums="48" hl_lines="6-17"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.6.1/meet-webcomponent-basic/public/js/app.js#L117-L133' target='_blank'>app.js</a>" linenums="117"
