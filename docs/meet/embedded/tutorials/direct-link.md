...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-meet-tutorials/tree/3.5.0/meet-direct-link){ .md-button target=\_blank }
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/src/index.js#L1-L23' target='_blank'>index.js</a>" linenums="1"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/src/index.js#L25-L58' target='_blank'>index.js</a>" linenums="25"
// Create a new room
...
2.  A new room is created using the OpenVidu Meet API by sending a `POST` request to the `rooms` endpoint. The request includes the room name and additional configuration options (with default values):
    ...
    ```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/src/index.js#L89-L111' target='_blank'>index.js</a>" linenums="89"
...
3.  If the room is successfully created, the server returns a `201 Created` response with the room object. Otherwise, the error is handled by the `handleApiError` function, which logs the error and returns an appropriate HTTP response:
    ...
    ```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/src/index.js#L113-L119' target='_blank'>index.js</a>" linenums="113"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/src/index.js#L60-L69' target='_blank'>index.js</a>" linenums="60"
// List all rooms
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/src/index.js#L71-L82' target='_blank'>index.js</a>" linenums="71"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/public/js/app.js#L1-L23' target='_blank'>app.js</a>" linenums="1"
...
1. Makes a `GET` request to the `/rooms` endpoint to fetch the list of rooms.
    ...
    ```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/public/js/app.js#L117-L134' target='_blank'>app.js</a>" linenums="117"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/public/js/app.js#L25-L75' target='_blank'>app.js</a>" linenums="25"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/public/js/app.js#L77-L103' target='_blank'>app.js</a>" linenums="77"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.5.0/meet-direct-link/public/js/app.js#L105-L115' target='_blank'>app.js</a>" linenums="105"
