...
![Home page of the tutorial app with the list of rooms](../../../../assets/images/meet/embedded/tutorials/recordings/home.png){ .control-height .round-corners loading=lazy }
</div>

<div class="grid-50" markdown>
![Recordings page of the tutorial app](../../../../assets/images/meet/embedded/tutorials/recordings/recordings.png){ .control-height .round-corners loading=lazy }
</div>
