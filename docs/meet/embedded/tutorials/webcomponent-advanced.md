...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-meet-tutorials/tree/3.6.0/meet-webcomponent-commands-events){ .md-button target=\_blank }
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.6.0/meet-webcomponent-commands-events/public/js/app.js#L48-83' target='_blank'>app.js</a>" linenums="48" hl_lines="6-25"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.6.0/meet-webcomponent-commands-events/public/js/app.js#L126-193' target='_blank'>app.js</a>" linenums="126"
