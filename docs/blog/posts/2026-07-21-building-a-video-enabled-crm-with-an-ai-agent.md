...
![OpenVidu Meet embedded in an AI-generated CRM — a real meeting with the participants panel open, inside the CRM](../../assets/images/blog/2026-07-21-building-a-video-enabled-crm-with-an-ai-agent/poster-light.png#only-light "A video meeting, right inside the CRM")
![OpenVidu Meet embedded in an AI-generated CRM — a real meeting with the participants panel open, inside the CRM](../../assets/images/blog/2026-07-21-building-a-video-enabled-crm-with-an-ai-agent/poster-dark.png#only-dark "A video meeting, right inside the CRM")
...
We recently ran this experiment: build a small CRM — clients, support issues, scheduled meetings — entirely with an AI agent, then ask the agent to integrate [OpenVidu Meet](../../meet/embedded/intro.md) so that meetings happen *inside* the app instead of in an external tool. Every prompt we typed is preserved in the repository, so this post is a faithful, reproducible walkthrough of the whole journey — including the parts where reality pushed back.

<!-- more -->

<video autoplay muted loop playsinline width="100%" style="border-radius: 10px; margin: 0.5em 0 1em 0;">
  <source src="/assets/images/blog/2026-07-21-building-a-video-enabled-crm-with-an-ai-agent/crm-meet-demo.mp4" type="video/mp4">
</video>
...
![The clients page of the generated CRM](../../assets/images/blog/2026-07-21-building-a-video-enabled-crm-with-an-ai-agent/clients.png "Clients as cards in a grid")

![The meetings calendar of the generated CRM](../../assets/images/blog/2026-07-21-building-a-video-enabled-crm-with-an-ai-agent/calendar.png "Meetings shown as a monthly calendar")
...
![Architecture: the CRM server provisions rooms and members through the OpenVidu Meet REST API; the browser embeds the meeting with the webcomponent](../../assets/images/blog/2026-07-21-building-a-video-enabled-crm-with-an-ai-agent/architecture.svg "How the CRM, the browser and OpenVidu Meet fit together"){ .svg-img }

![An issue with its planned and past meetings](../../assets/images/blog/2026-07-21-building-a-video-enabled-crm-with-an-ai-agent/issue-meetings.png "Each issue tracks its meetings — with a Join button that opens the meeting in-app")
...
![The client page showing meeting room access](../../assets/images/blog/2026-07-21-building-a-video-enabled-crm-with-an-ai-agent/client-meet-access.png "The client's guest membership, managed from the CRM")

![The fine-grained permissions editor](../../assets/images/blog/2026-07-21-building-a-video-enabled-crm-with-an-ai-agent/permissions-editor.png "Base role plus 14 per-member permissions, straight from the CRM UI")
