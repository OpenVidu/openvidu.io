...
![OpenVidu gesture control](https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExZXBvdmlnMjF4a2phc3ZnejI1dndsemhuZjR0dzhuNWF4MmZsMG9ydSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/N7aCOnWxcmMSlOy2eH/giphy.gif){ .round-corners loading=lazy }
...
[MediaPipe :fontawesome-solid-external-link:{.external-link-icon}](https://developers.google.com/edge/mediapipe/solutions/guide){:target="_blank"} is Google's family of computer vision models, built to run on your own device instead of on a server.
...
![Confused robot gif representing the model losing hand tracking](https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExZ2c0OHYyemhvaXZkZDdpb20xZTkxNGNtNnh2bDRqaWNtZjhvdmVtcSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/h8HmN0UcEKR0xWnv3R/giphy.gif){ .round-corners loading=lazy }
/// caption
