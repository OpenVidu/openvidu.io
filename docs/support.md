...
!!! info
    Do you need help [**updating from OpenVidu 2 to OpenVidu 3**](https://docs.openvidu.io/en/latest/openvidu3/){:target=_blank}? Write us to [commercial@openvidu.io](mailto:commercial@openvidu.io){:target=_blank} and we will be happy to guide you through the process.
