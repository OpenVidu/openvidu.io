...
- When using [mediasoup](self-hosting/production-ready/performance.md):
    ...
    - Limited [ingress](https://docs.livekit.io/transport/media/ingress-egress/ingress/){target="\_blank"} support: non-simulcast video tracks are not supported. Firefox may experience issues when subscribing to ingress video.
