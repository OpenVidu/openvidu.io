---
title: "Administer OpenVidu Single Node PRO on Azure"
description: "Administer OpenVidu Single Node PRO on Azure: start and stop it, change its configuration and back up its data."
---
...
=== "Stop OpenVidu Single Node PRO"
    ...
    ![Stop instance](../../../../assets/images/platform/self-hosting/single-node/azure/stop-instance.png){ .svg-img .dark-img }
...
=== "Start OpenVidu Single Node PRO"
    ...
    ![Start instance](../../../../assets/images/platform/self-hosting/single-node/azure/start-instance.png){ .svg-img .dark-img }
...
3. In the left panel click on _"Availability + scale"_ -> _"Size"_.
    ...
    === "Change instance type"
        ...
        ![Change instance type](../../../../assets/images/platform/self-hosting/single-node/azure/instance-type.png){ .svg-img .dark-img }
...
=== "Changing configuration through Key Vault secrets"
    ...
    6. Go to the Instance resource of OpenVidu and click on _"Restart"_ to apply the changes to the OpenVidu Single Node PRO deployment.
        ![Reboot Instance](../../../../assets/images/platform/self-hosting/single-node/azure/reboot-instance.png){ .svg-img .dark-img }
