---
title: "Install OpenVidu Single Node PRO on Azure"
...
# OpenVidu Single Node **PRO**{ .openvidu-tag .openvidu-pro-tag .openvidu-tag-heading } installation: Azure
