...
This page documents creating a VM in Oracle Cloud Infrastructure (OCI) and updating network policies. Installing, administrating, and updating OpenVidu Single Node <span class="openvidu-tag openvidu-pro-tag" style="font-size: .6em; vertical-align: text-bottom">PRO</span> are refered to On Premises install.
...
* In [On Premises Administration section](../on-premises/admin.md) you will find all the administration of this OpenVidu Single Node <span class="openvidu-tag openvidu-pro-tag" style="font-size: .6em; vertical-align: text-bottom">PRO</span> deployment.   
