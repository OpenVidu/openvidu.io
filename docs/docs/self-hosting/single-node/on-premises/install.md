...
- The machine **must have a Public IP**. An FQDN (Fully Qualified Domain Name) is optional. If not provided, an autogenerated domain using [sslip.io :fontawesome-solid-external-link:{.external-link-icon}](https://sslip.io){:target="_blank"} will be used.
...
- **Domain name** (Optional): The domain name for your deployment. If left empty, an autogenerated domain using [sslip.io :fontawesome-solid-external-link:{.external-link-icon}](https://sslip.io){:target="_blank"} (e.g., `10-20-30-40.sslip.io`) will be used based on your machine's public IP. For production environments, it's recommended to provide your own FQDN.
...
=== "Without Domain Name"
    ...
    === "Let's Encrypt certificates"
        ...
        Example using Let's Encrypt certificates with autogenerated [sslip.io :fontawesome-solid-external-link:{.external-link-icon}](https://sslip.io ){:target="_blank"} domain:
    ...
    === "Self-signed certificates"
        ...
        Example using self-signed certificates with autogenerated [sslip.io :fontawesome-solid-external-link:{.external-link-icon}](https://sslip.io){:target="_blank"} domain:
...
- The argument `--domain-name` is optional. If not provided, an autogenerated domain using [sslip.io :fontawesome-solid-external-link:{.external-link-icon}](https://sslip.io){:target="_blank"} will be used based on your machine's public IP.
