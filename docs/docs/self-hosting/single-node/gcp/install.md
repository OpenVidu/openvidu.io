...
| rtcEngine **PRO**{ .openvidu-tag .openvidu-pro-tag .openvidu-tag-10px } | "pion" | RTCEngine media engine to use. Allowed values are 'pion' and 'mediasoup'. Only applies to the PRO edition. |
