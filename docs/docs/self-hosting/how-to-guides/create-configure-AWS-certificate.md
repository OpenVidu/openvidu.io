...
=== "AWS Certificate creation"
    ...
    ![AWS Certificate Manager view](../../../assets/images/platform/self-hosting/how-to-guides/create-configure-cert/domain-name-for-certificate.png){ .round-corners .dark-img loading=lazy }
    /// caption
...
=== "Create record in Route 53"
    ...
    ![Create record in Route 53](../../../assets/images/platform/self-hosting/how-to-guides/create-configure-cert/create-record-route53.png){ .round-corners .dark-img loading=lazy }
    ...
    ![Create record page](../../../assets/images/platform/self-hosting/how-to-guides/create-configure-cert/create-record-page.png){ .round-corners .dark-img loading=lazy }
    /// caption
...
=== "Configuration of Load Balancer"
    ...
    ![Load Balancer configuration](../../../assets/images/platform/self-hosting/how-to-guides/create-configure-cert/load-balancer-config.png){ .round-corners .dark-img loading=lazy }
    ...
    ![ARN and domain location](../../../assets/images/platform/self-hosting/how-to-guides/create-configure-cert/domain-arn-location.png){ .round-corners .dark-img loading=lazy }
    /// caption
...
=== "Associating the Load Balancer"
    ...
    ![Create Load Balancer record](../../../assets/images/platform/self-hosting/how-to-guides/create-configure-cert/create-lbrecord.png){ .round-corners .dark-img loading=lazy }
