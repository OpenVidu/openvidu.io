...
=== "Shutting down the cluster"
    ...
    2. Then click into the Virtual Machine Scale Set resource called `<STACK_NAME>-mediaNodeScaleSet` and click _"Availability + scale"_ on the left panel, then click the _"Scaling"_ option.
        ...
        ![Selecting scaling menu Scale Set](../../../../assets/images/platform/self-hosting/elastic/azure/elastic-admin-scaling-tab.png){ .round-corners loading=lazy }

    3. On this tab, scroll to the bottom and modify the _"Instance Limits"_ to 0.

        ![Edit Scaling Set Group](../../../../assets/images/platform/self-hosting/elastic/azure/elastic-admin-edit-media-ss-to-stop.png){ .round-corners loading=lazy }

    4. Click _"Save"_ and wait for it to complete. You can check the progress in the _"Instances"_ tab.

        ![Location Instance Tab](../../../../assets/images/platform/self-hosting/shared/azure/admin-instance-tab.png){ .round-corners loading=lazy }
    ...
    5. After confirming that all Media Node instances are terminated, go back to the Resource Group and locate the resource called _"stackName-VM-MasterNode"_. Click on it to go to the Master Node instance. There, click on _"Stop"_ to stop the instance.
        ...
        ![Delete Deployment Stack](../../../../assets/images/platform/self-hosting/elastic/azure/elastic-admin-stop-master.png){ .round-corners loading=lazy }
...
=== "Starting up the cluster"
    ...
    2. In the resource group click on the resource called _"stackName-VM-MasterNode"_, then click _"Start"_ to start the Master Node.
        ...
        ![Start Master Node](../../../../assets/images/platform/self-hosting/elastic/azure/elastic-admin-start-master.png){ .round-corners loading=lazy }
    ...
    5. On this tab, modify the _"Instance Limits"_ to your desired values.
        ...
        ![Edit Scaling Set Group](../../../../assets/images/platform/self-hosting/elastic/azure/elastic-admin-edit-media-ss-to-start.png){ .round-corners loading=lazy }
...
=== "Master Nodes"
    ...
    3. On the left panel click on _"Availability + scale"_ tab and inside click on _"Size"_ tab. Then select the size you desire and click on _"Resize"_
        ...
        ![Change instance type master](../../../../assets/images/platform/self-hosting/elastic/azure/instance-type-master.png){ .round-corners loading=lazy }
...
=== "Media Nodes"
    ...
    4. On the left panel click on _"Availability + scale"_ tab, then on _"Size"_.
        ...
        ![Change instance type media](../../../../assets/images/platform/self-hosting/elastic/azure/instance-type-media.png){ .round-corners loading=lazy }
...
=== "Media Nodes Autoscaling Configuration"
    ...
    4. On the left panel click on _"Availability + scale"_ tab and inside click on _"Scaling"_ option.
        ...
        ![Select scaling option](../../../../assets/images/platform/self-hosting/elastic/azure/elastic-scaling-tab.png){ .round-corners loading=lazy }
    ...
    5. In the _"Default"_ box you will find a section called _"Rules"_. Here you can add new rules or modify existing ones.
        ...
        ![Rules section](../../../../assets/images/platform/self-hosting/elastic/azure/rules-section-ss.png){ .round-corners loading=lazy }

    === "Modify existing rules"

        Click on the rule you want to modify and change the **Criteria** as desired. To accept the changes click on _"Update_".

        ![Modify an existing rule](../../../../assets/images/platform/self-hosting/elastic/azure/rules-modify-rule-ss.png){ .round-corners loading=lazy }

    === "Add a new rule"

        Click on _"Add a rule"_ option and fill the **Criteria** as desired. To add the rule click on _"Add"_.

        ![Modify an existing rule](../../../../assets/images/platform/self-hosting/elastic/azure/rules-add-rule-ss.png){ .round-corners loading=lazy }
...
=== "Set Fixed Number of Media Nodes"
    ...
    4. On this tab, scroll to the bottom and modify the _"Instance Limits"_ to the value of fixed number of Media Nodes you want. In this case it is set to 2.
        ...
        ![Edit Scaling Set Group](../../../../assets/images/platform/self-hosting/elastic/azure/elastic-admin-edit-media-ss-fixed.png){ .round-corners loading=lazy }
...
=== "Changing configuration through Key Vault secrets"
    ...
    6. Go to the Master Node resource and click on _"Restart"_ to apply the changes to the OpenVidu Elastic deployment.
        ...
        ![Reboot Instance](../../../../assets/images/platform/self-hosting/elastic/azure/reboot-instance.png){ .round-corners loading=lazy }
