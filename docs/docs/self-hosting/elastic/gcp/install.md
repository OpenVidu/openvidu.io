...
This section describes how to deploy a production-ready OpenVidu Elastic instance on Google Cloud Platform. The deployed services are identical to those in the [On Premises Elastic installation](../on-premises/install.md), but are provisioned as Google Cloud Platform resources and can be automated using an Google Cloud Console.
...
* Fill **Deployment ID** with any name that you desire (for example openvidu-elastic-deployment).   
...
!!! warning
    ...
    <figure markdown>
    ![Google Cloud Platform input variables](../../../../assets/images/self-hosting/elastic/gcp/gcp-cloud-build-logs.png){ .svg-img .dark-img }
    </figure>
...
=== "Check deployment outputs in the instance"
    ...
    <figure markdown>
    ![Google Cloud Platform gcloud command](../../../../assets/images/self-hosting/elastic/gcp/gcp-gcloud-command.png){ .svg-img .dark-img }
    </figure>   
