...
* For the **Git ref**, use <span class="copy-inline" data-copy="v3.6.1"><code>v3.6.1</code><span class="copy-btn" title="Copy">:material-content-copy:</span></span>, corresponding to the version you want to deploy. 
