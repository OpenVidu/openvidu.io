...
=== "Architecture overview"
    ...
    ![OpenVidu High Availability Google Cloud Platform Architecture](../../../../assets/images/platform/self-hosting/ha/gcp/ha-architecture.svg){ .dark-img loading=lazy }
...
* Fill the **Git directory** with the following path:
    ...
    ```
    openvidu-deployment/pro/ha/gcp
    ```
...
!!! warning
    ...
    ![Google Cloud Platform input variables](../../../../assets/images/platform/self-hosting/ha/gcp/cloud-build-logs.png){ .round-corners .dark-img loading=lazy }
...
=== "Check deployment outputs in the instance"
    ...
    ![Google Cloud Platform gcloud command](../../../../assets/images/platform/self-hosting/ha/gcp/gcloud-command.png){ .round-corners .dark-img loading=lazy }
