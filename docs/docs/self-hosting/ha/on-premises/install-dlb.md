...
=== "Architecture overview"
    ...
    ![OpenVidu High Availability Architecture with DNS Load Balancing](../../../../assets/images/platform/self-hosting/ha/on-premises/ha-dlb-architecture.svg){ .round-corners .dark-img loading=lazy }
