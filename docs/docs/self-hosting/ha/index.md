...
OpenVidu High Availability is part of the <span class="openvidu-tag openvidu-pro-tag openvidu-tag-12px">PRO</span> edition of OpenVidu. You have the following deployment options:
