...
=== "Architecture overview"
    ...
    ![OpenVidu High Availability Azure Architecture](../../../../assets/images/platform/self-hosting/ha/azure/ha-architecture.svg){ .dark-img loading=lazy }
...
=== "OpenVidu HA Configuration"
    ...
    ![OpenVidu HA Configuration](../../../../assets/images/platform/self-hosting/ha/azure/openvidu-ha-config.png){ .round-corners .dark-img loading=lazy }
...
=== "Azure Instance configuration"
    ...
    ![Azure Instance configuration](../../../../assets/images/platform/self-hosting/ha/azure/instance-config.png){ .round-corners .dark-img loading=lazy }
...
=== "Check deployment outputs in the instance"
    ...
    2. Inside the Virtual Machine resource, click on _"Connect"_ 🡒 _"Connect via Bastion"_.
            ![Connect via bastion](../../../../assets/images/platform/self-hosting/ha/azure/connect-bastion.png){ .round-corners .dark-img loading=lazy }

    3. Click on _"Deploy Bastion"_ button.
            ![Deploy bastion](../../../../assets/images/platform/self-hosting/ha/azure/bastion-deploy.png){ .round-corners .dark-img loading=lazy }
    ...
    4. Change **Authentication Type** to _"SSH Private Key from Local File"_, set the same username used when you deployed OpenVidu, and select the local file corresponding to the SSH Private Key of the SSH Key used when deploying.
            ![Bastion parameters](../../../../assets/images/platform/self-hosting/ha/azure/bastion-parameters.png){ .round-corners .dark-img loading=lazy }
