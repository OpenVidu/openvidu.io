...
Currently there are two [client SDK events](https://docs.livekit.io/intro/basics/rooms-participants-tracks/webhooks-events/#sdk-events){target="\_blank"} that are not triggered when using mediasoup:
