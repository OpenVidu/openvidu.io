...
![Analytics page of OpenVidu Dashboard with client SDK and connection charts](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/analytics1.png){ .round-corners loading=lazy }
</div>

<div class="grid-50" markdown>
![Bandwidth usage charts in the OpenVidu Dashboard analytics page](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/analytics2.png){ .round-corners loading=lazy }
</div>
...
<div class="grid-50" markdown>
![Participant and room charts in the OpenVidu Dashboard analytics page](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/analytics3.png){ .round-corners loading=lazy }
</div>

<div class="grid-50" markdown>
![Egress charts in the OpenVidu Dashboard analytics page](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/analytics4.png){ .round-corners loading=lazy }
</div>
...
![OpenVidu Dashboard listing with an active room](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/room_active.png){ .round-corners loading=lazy }
</div>

<div class="grid-33" markdown>
![Room details page with duration, bandwidth and participants](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/room1.png){ .round-corners loading=lazy }
</div>

<div class="grid-33" markdown>
![Timeline and related egresses in the room details page](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/room2.png){ .round-corners loading=lazy }
</div>
...
<div class="grid-50" markdown>
![Participant details page with duration and bandwidth usage](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/participant1.png){ .round-corners loading=lazy }
</div>

<div class="grid-50" markdown>
![Audio and video quality scores in the participant details page](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/participant2.png){ .round-corners loading=lazy }
</div>
...
<div class="grid-50" markdown>
![Egress details page with duration, status and type](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/egress1.png){ .round-corners loading=lazy }
</div>

<div class="grid-50" markdown>
![Destination and room information in the egress details page](../../../../assets/images/platform/self-hosting/production-ready/observability/openvidu-dashboard/egress2.png){ .round-corners loading=lazy }
</div>
