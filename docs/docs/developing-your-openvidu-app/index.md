...
=== ":simple-nodedotjs:{.icon .lg-icon .tab-icon} Node.js"
    ...
    [:octicons-arrow-right-24: Reference Docs](https://docs.livekit.io/reference/server-sdk-js/){target="\_blank"}
...
=== ":material-api:{.icon .lg-icon .tab-icon} Server API"
    ...
    1. Consume the Server API directly: [:octicons-arrow-right-24: Reference Docs](https://docs.livekit.io/reference/other/roomservice-api/){target="\_blank"}
