---
description: "OpenVidu apps can use LiveKit-compatible React Components: ready-to-use components, hooks and contexts for real-time audio/video development."
---
