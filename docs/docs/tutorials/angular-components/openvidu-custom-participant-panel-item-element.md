...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-tutorials/tree/3.4.1/openvidu-components-angular/openvidu-custom-participant-panel-item-elements){ .md-button target=\_blank }
