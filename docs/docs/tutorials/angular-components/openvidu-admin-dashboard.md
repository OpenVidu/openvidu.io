...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-tutorials/tree/3.6.1/openvidu-components-angular/openvidu-admin-dashboard){ .md-button target=\_blank }
