...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-tutorials/tree/3.1.0/openvidu-components-angular/openvidu-custom-participants-panel){ .md-button target=\_blank }
