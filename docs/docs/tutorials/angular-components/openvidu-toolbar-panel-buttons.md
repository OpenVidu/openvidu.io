...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-tutorials/tree/3.8.0/openvidu-components-angular/openvidu-toolbar-panel-buttons){ .md-button target="_blank" }
...
![OpenVidu Components Angular](../../../assets/images/platform/tutorials/angular-components/toolbar-panel-buttons.svg){ .control-height loading=lazy }
...
1.  Navigate into the application client directory:
    ...
    ```bash
      cd openvidu-tutorials/openvidu-components-angular/openvidu-toolbar-panel-buttons
    ```
