...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-tutorials/tree/3.2.0/openvidu-components-angular/openvidu-custom-toolbar){ .md-button target=\_blank }
