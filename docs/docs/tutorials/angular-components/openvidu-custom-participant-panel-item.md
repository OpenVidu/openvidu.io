---
title: "Custom participant panel item"
description: "Replace each row of the participants panel with a component of your own using OpenVidu Angular Components, and show the data you care about."
---
...
![OpenVidu Components Angular](../../../assets/images/platform/tutorials/angular-components/participant-panel-item.svg){ .control-height loading=lazy }
...
1.  Navigate into the application client directory:
    ...
    ```bash
      cd openvidu-tutorials/openvidu-components-angular/openvidu-custom-participant-panel-item
    ```
