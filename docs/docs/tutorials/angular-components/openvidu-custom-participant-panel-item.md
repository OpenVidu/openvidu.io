...
![OpenVidu Components Angular](../../../assets/images/platform/tutorials/angular-components/openvidu-components-participant-panel-item.svg){ loading=lazy .mkdocs-img }
