...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-tutorials/tree/3.5.0/openvidu-components-angular/openvidu-custom-participant-panel-item){ .md-button target=\_blank }
