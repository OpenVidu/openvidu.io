...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-tutorials/tree/3.7.0/openvidu-components-angular/openvidu-toolbar-buttons){ .md-button target=\_blank }
