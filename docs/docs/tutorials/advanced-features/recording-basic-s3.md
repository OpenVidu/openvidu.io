...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.4.0/advanced-features/openvidu-recording-basic-node){ .md-button target=\_blank }
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.0/advanced-features/openvidu-recording-basic-node/src/index.js#L121-L149' target='_blank'>index.js</a>" linenums="121"
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.0/advanced-features/openvidu-recording-basic-node/src/s3.service.js' target='_blank'>s3.service.js</a>" linenums="9"
// S3 configuration
