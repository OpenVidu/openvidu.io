...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.6.1/application-client/openvidu-ionic){ .md-button target=\_blank }
...
```typescript title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-ionic/src/app/app.component.ts#L33-L123' target='_blank'>app.component.ts</a>" linenums="33"
type TrackInfo = { // (1)!
...
```typescript title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-ionic/src/app/app.component.ts#L131-L180' target='_blank'>app.component.ts</a>" linenums="131"
async joinRoom() {
...
4.  It requests a token from the application server using the room name and participant name. This is done by calling the `getToken()` method:
    ...
    ```typescript title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-ionic/src/app/app.component.ts#L197-L215' target='_blank'>app.component.ts</a>" linenums="197"
    /**
     * --------------------------------------------
...
```html title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-ionic/src/app/app.component.html#L108-L125' target='_blank'>app.component.html</a>" linenums="108"
...
```typescript title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-ionic/src/app/video/video.component.ts#L4-L27' target='_blank'>video.component.ts</a>" linenums="3"
// (1)!
@Component({
...
```typescript title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-ionic/src/app/audio/audio.component.ts#L4-L25' target='_blank'>audio.component.ts</a>" linenums="3"
// (1)!
@Component({
...
```typescript title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-ionic/src/app/app.component.ts#L182-L195' target='_blank'>app.component.ts</a>" linenums="182"
async leaveRoom() {
...
=== ":fontawesome-brands-android:{.icon .lg-icon .tab-icon} Android"
    ...
    ```xml title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-ionic/android/app/src/main/AndroidManifest.xml#L41-L43' target='_blank'>AndroidManifest.xml</a>" linenums="41"
...
=== ":fontawesome-brands-apple:{.icon .lg-icon .tab-icon} iOS"
    ...
    ```xml title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.1/application-client/openvidu-ionic/ios/App/App/Info.plist#L48-L51' target='_blank'>Info.plist</a>" linenums="48"
