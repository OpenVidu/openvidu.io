...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.4.0/application-server/java){ .md-button target=\_blank }
...
```java title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.0/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L19-L27' target='_blank'>Controller.java</a>" linenums="19"
...
```java title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.0/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L33-L48' target='_blank'>Controller.java</a>" linenums="33"
...
```java title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.0/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L50-L60' target='_blank'>Controller.java</a>" linenums="50"
