...
description: "Build a minimal Java application server with Spring Boot using OpenVidu's LiveKit-compatible Kotlin SDK: generate tokens and receive webhook events."
---
...
```java title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L19-L27' target='_blank'>Controller.java</a>" linenums="19"
...
```java title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L33-L48' target='_blank'>Controller.java</a>" linenums="33"
