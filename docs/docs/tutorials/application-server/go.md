...
description: "Build a minimal Go application server with Gin using OpenVidu's LiveKit-compatible Go SDK: generate tokens and receive webhook events."
---
...
```go title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/go/main.go#L63-L70' target='_blank'>main.go</a>" linenums="63"
func main() {
	loadEnv() // (1)!
...
```go title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/go/main.go#L19-L49' target='_blank'>main.go</a>" linenums="19"
