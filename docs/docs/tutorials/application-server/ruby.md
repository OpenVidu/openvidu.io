...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.6.0/application-server/ruby){ .md-button target=\_blank }
...
```ruby title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.0/application-server/ruby/app.rb#L1-L17' target='_blank'>app.rb</a>" linenums="1"
require 'sinatra'
...
```ruby title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.0/application-server/ruby/app.rb#L19-L34' target='_blank'>app.rb</a>" linenums="19"
post '/token' do
...
```ruby title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.0/application-server/ruby/app.rb#L36-L47' target='_blank'>app.rb</a>" linenums="36"
