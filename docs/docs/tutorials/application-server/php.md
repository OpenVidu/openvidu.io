...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.6.0/application-server/php){ .md-button target=\_blank }
...
```php title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.0/application-server/php/index.php#L1-L17' target='_blank'>index.php</a>" linenums="1"
<?php
...
```php title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.0/application-server/php/index.php#L19-L43' target='_blank'>index.php</a>" linenums="18"
<?php
...
```php title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.6.0/application-server/php/index.php#L45-L62' target='_blank'>index.php</a>" linenums="44"
<?php
