...
[Source code :simple-github:](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.7.0/ai-services/openvidu-live-captions){ .md-button target=\_blank }
...
```javascript title="<a href='https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/ai-services/openvidu-live-captions/src/app.js#L60-L74' target='_blank'>app.js</a>" linenums="60"
