...
!!! info
    ...
    Refer to [LiveKit documentation](https://docs.livekit.io/agents/multimodality/text/#frontend-rendering){:target="\_blank"} to see how to handle transcription events in other frontend platforms.
