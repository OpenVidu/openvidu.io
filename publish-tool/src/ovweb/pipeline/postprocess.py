...
#: The two files that make up the site's AI-facing channel: an index of every page's Markdown
#: export, and the concatenation of all of them. Both are served only from the site root.
