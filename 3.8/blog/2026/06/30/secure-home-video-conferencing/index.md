...
With a tiny computer like a Raspberry Pi, an old laptop or a mini-PC, you can have your own private video conferencing server running in a matter of minutes. This guide walks you through it in three simple steps using [OpenVidu Meet](/meet/) .
...
- **[OpenVidu Single Node PRO](https://openvidu.io/3.8/docs/self-hosting/single-node/index.md)**: the same single-machine setup, with 2x performance using [Mediasoup](https://mediasoup.org/) and advanced observability.
