...
1. Run the three components in separate terminals:
   ...
   - Terminal 1: install and run OpenVidu locally following the [official instructions](https://openvidu.io/3.8/docs/self-hosting/local/index.md).
