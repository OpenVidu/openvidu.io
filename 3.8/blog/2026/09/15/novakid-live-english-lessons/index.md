...
If you're weighing the same build-vs-buy-vs-self-host question Novakid faced, [OpenVidu Platform](https://openvidu.io/3.8/docs/index.md) gives you the LiveKit-compatible SDKs, self-hosted control and AWS-native deployment tooling this story is built on. See the [self-hosting deployment types](https://openvidu.io/3.8/docs/self-hosting/deployment-types/index.md) to find the topology that matches your own scale.

Thinking about your own success story?

We're always happy to talk to teams building real-time features. If you're an OpenVidu user with a story like this one, [get in touch](https://openvidu.io/3.8/support/index.md): we'll do the writing, you get the visibility and the backlinks.
