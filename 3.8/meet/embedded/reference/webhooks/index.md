...
Visit [OpenVidu Meet Webhooks](https://openvidu.io/3.8/meet/embedded/reference/api.html#/webhooks/recordingStartedWebhook) reference documentation for a complete list of all available webhook events. They include:

- [`meetingStarted`](https://openvidu.io/3.8/meet/embedded/reference/api.html#/webhooks/meetingStartedWebhook)
- [`meetingEnded`](https://openvidu.io/3.8/meet/embedded/reference/api.html#/webhooks/meetingEndedWebhook)
- [`recordingStarted`](https://openvidu.io/3.8/meet/embedded/reference/api.html#/webhooks/recordingStartedWebhook)
- [`recordingUpdated`](https://openvidu.io/3.8/meet/embedded/reference/api.html#/webhooks/recordingUpdatedWebhook)
- [`recordingEnded`](https://openvidu.io/3.8/meet/embedded/reference/api.html#/webhooks/recordingEndedWebhook)
...
Checkout [working example](https://github.com/OpenVidu/openvidu-meet/tree/v3.8.0/webhooks-snippets/node)
...
Checkout [working example](https://github.com/OpenVidu/openvidu-meet/tree/v3.8.0/webhooks-snippets/java)
...
Checkout [working example](https://github.com/OpenVidu/openvidu-meet/tree/v3.8.0/webhooks-snippets/go)
...
Checkout [working example](https://github.com/OpenVidu/openvidu-meet/tree/v3.8.0/webhooks-snippets/python)
...
Checkout [working example](https://github.com/OpenVidu/openvidu-meet/tree/v3.8.0/webhooks-snippets/php)
...
Checkout [working example](https://github.com/OpenVidu/openvidu-meet/tree/v3.8.0/webhooks-snippets/dotnet)
...
Checkout [working example](https://github.com/OpenVidu/openvidu-meet/tree/v3.8.0/webhooks-snippets/ruby)
...
Checkout [working example](https://github.com/OpenVidu/openvidu-meet/tree/v3.8.0/webhooks-snippets/rust)
