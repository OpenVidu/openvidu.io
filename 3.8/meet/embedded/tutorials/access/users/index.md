...
This tutorial extends the [Identified Guests tutorial](https://openvidu.io/3.8/meet/embedded/tutorials/access/identified-guests/index.md) to show how to create **OpenVidu Meet users** with the Users API and add them to a room as **members**.
...
The application uses the [OpenVidu Meet API](https://openvidu.io/3.8/meet/embedded/reference/rest-api/index.md) to manage users, rooms and room members, and the [OpenVidu Meet WebComponent](https://openvidu.io/3.8/meet/embedded/reference/webcomponent/index.md) to embed the meeting.

> **Users, identified guests and anonymous guests**
>
> A room member can be a **user** (a real OpenVidu Meet account that authenticates with its credentials) or an **identified guest** (no account, accesses the room through a unique link). On top of explicit members, a room also accepts **anonymous guests** through the shared moderator/speaker links. See the [Room Members](https://openvidu.io/3.8/meet/features/room-members/overview/index.md) feature for the full picture.
...
The room endpoints (`POST /rooms`, `GET /rooms`, `DELETE /rooms/:roomId`) and the `DELETE /rooms/:roomId/members/:memberId` endpoint are identical to the [Identified Guests tutorial](https://openvidu.io/3.8/meet/embedded/tutorials/access/identified-guests/index.md).
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/src/index.js#L25-L50)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/src/index.js#L52-L62)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/src/index.js#L64-L75)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/src/index.js#L128-L152)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/src/index.js#L154-L165)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/public/js/app.js#L87-L120)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/public/js/app.js#L337-L350)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/public/js/app.js#L412-L444)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/public/js/app.js#L352-L410)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/access/meet-users/public/js/app.js#L514-L518)
