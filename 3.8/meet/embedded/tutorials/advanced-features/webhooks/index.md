...
[Source code](https://github.com/OpenVidu/openvidu-meet-tutorials/tree/3.8.0/advanced-features/meet-webhooks)

This tutorial extends the [recordings tutorial](https://openvidu.io/3.8/meet/embedded/tutorials/advanced-features/recordings/index.md) to add **real-time updates** through webhooks and Server-Sent Events (SSE). It demonstrates how to receive and process OpenVidu Meet webhooks to provide live status updates for rooms and recordings.
...
This tutorial builds upon the [recordings tutorial](https://openvidu.io/3.8/meet/embedded/tutorials/advanced-features/recordings/index.md), adding real-time functionality through webhooks and Server-Sent Events. We'll focus on the new webhook handling capabilities and live update features.
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/advanced-features/meet-webhooks/src/index.js#L1-L27)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/advanced-features/meet-webhooks/src/index.js#L128-L129)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/advanced-features/meet-webhooks/src/index.js#L131-L147)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/advanced-features/meet-webhooks/src/index.js#L186-L213)
...
>
> You can find examples of how to verify OpenVidu Meet webhooks in other programming languages in the [Validate events](https://openvidu.io/3.8/meet/embedded/reference/webhooks/#validate-events) section of the Webhooks reference.
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/advanced-features/meet-webhooks/public/js/app.js#L4-L8)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/advanced-features/meet-webhooks/public/js/app.js#L389-L410)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/advanced-features/meet-webhooks/public/js/app.js#L412-L433)
...
1. Update the rooms map with the new room info and re-render the room list with the updated status.
1. Check if the user is viewing recordings for the relevant room before adding new recordings.
1. Prepend the new recording to the recordings map and re-render the recordings list so it appears first.
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/advanced-features/meet-webhooks/public/js/app.js#L488-L499)
...
1. Return true only when there is no room filter, or the room name matches the current filter, so recording updates are applied only when relevant.
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/advanced-features/meet-webhooks/public/js/app.js#L53-L121)
...
1. Destructure the entry for the room's current status, falling back to the `closed` entry for any unknown status.
...
1. **Configure webhooks in OpenVidu Meet**: Set up webhooks in your OpenVidu Meet production deployment to point to this tutorial. Follow the instructions in the [Webhooks configuration](https://openvidu.io/3.8/meet/embedded/reference/webhooks/#configuration) section to learn how to configure a webhook URL. Use the public URL of this tutorial followed by `/webhook` (e.g., `https://your-tutorial-domain.com:XXXX/webhook`).
