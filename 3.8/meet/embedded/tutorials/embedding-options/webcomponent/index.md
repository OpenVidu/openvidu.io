...
The application uses the [OpenVidu Meet API](https://openvidu.io/3.8/meet/embedded/reference/rest-api/index.md) to create and delete rooms, and the [OpenVidu Meet WebComponent](https://openvidu.io/3.8/meet/embedded/reference/webcomponent/index.md) to embed the video call interface directly into the application.
...
This tutorial builds upon the [Direct Link tutorial](https://openvidu.io/3.8/meet/embedded/tutorials/embedding-options/direct-link/index.md), replacing external redirect links with an embedded OpenVidu Meet WebComponent. The backend remains identical, so we'll focus on the frontend modifications that enable WebComponent integration.

______________________________________________________________________

### Backend

The backend is identical to the [Direct Link tutorial](https://openvidu.io/3.8/meet/embedded/tutorials/embedding-options/direct-link/index.md). It provides the same three REST API endpoints:
...
[index.html](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/embedding-options/meet-webcomponent-basic/public/index.html#L80-L81)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/embedding-options/meet-webcomponent-basic/public/js/app.js#L50-L84)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.8.0/embedding-options/meet-webcomponent-basic/public/js/app.js#L131-L147)
