...
Room Members tab listing users and identified guests
...
Member edit dialog with base role and custom permissions
...
Member list with the action to copy a member's access link
