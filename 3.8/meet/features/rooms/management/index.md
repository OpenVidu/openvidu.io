...
Room configuration wizard editing an existing room
...
Rooms page listing rooms with their actions
...
Auto-deletion date setting when creating a room
...
Auto-deletion policy options for the room and its recordings
...
Room appearance settings in the Configuration page
