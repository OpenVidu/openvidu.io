...
\[[![](../assets/videos/meet/home/demo-poster.jpg)](../assets/videos/meet/home/demo-preview.mp4)\](https://openvidu.io/3.8/assets/videos/meet/home/demo.mp4)

[Deploy Meet in minutes](https://openvidu.io/3.8/meet/getting-started/index.md) [Try OpenVidu Meet Demo](https://meet-demo-app.openvidu.io)
...
- **Background filters**
  ...
  \[[](../assets/videos/meet/meetings/virtual-background/virtual-bg-meeting-dark.mp4#only-dark)\](https://openvidu.io/3.8/assets/videos/meet/meetings/virtual-background/virtual-bg-meeting-dark.mp4) \[[](../assets/videos/meet/meetings/virtual-background/virtual-bg-meeting-light.mp4#only-light)\](https://openvidu.io/3.8/assets/videos/meet/meetings/virtual-background/virtual-bg-meeting-light.mp4)

**Record and share**

OpenVidu Meet offers high-quality recordings and greatly simplifies their storage and access control.

\[[](../assets/videos/meet/recordings/management/share-recording-dark.mp4#only-dark)\](https://openvidu.io/3.8/assets/videos/meet/recordings/management/share-recording-dark.mp4) \[[](../assets/videos/meet/recordings/management/share-recording-light.mp4#only-light)\](https://openvidu.io/3.8/assets/videos/meet/recordings/management/share-recording-light.mp4)
...
- **Pre-configure your rooms**
  ...
  \[[](../assets/videos/meet/rooms/management/create-room-wizard-dark.mp4#only-dark)\](https://openvidu.io/3.8/assets/videos/meet/rooms/management/create-room-wizard-dark.mp4) \[[](../assets/videos/meet/rooms/management/create-room-wizard-light.mp4#only-light)\](https://openvidu.io/3.8/assets/videos/meet/rooms/management/create-room-wizard-light.mp4)
...
\[[](../assets/videos/meet/home/embed-html.mp4)\](https://openvidu.io/3.8/assets/videos/meet/home/embed-html.mp4)
...
## Explore [**OpenVidu Meet Embedded**](https://openvidu.io/3.8/meet/embedded/intro) to integrate video calls into your application.
...
## Check out the [**deployment documentation**](https://openvidu.io/3.8/meet/deployment/overview).
...
OpenVidu PRO follows a simple pricing model based on the size of your deployment (number of CPU cores). Check the [OpenVidu pricing page](/pricing/) for more details.

## You can choose the OpenVidu edition that best fits your needs when [deploying OpenVidu Meet](https://openvidu.io/3.8/meet/deployment/overview).

______________________________________________________________________

## Need total control and advanced SDKs to build your custom real-time application? Check out [**OpenVidu Platform**](https://openvidu.io/3.8/docs). Not sure which one fits? [Compare Meet vs Platform](/openvidu-meet-vs-openvidu-platform/).
