...
You can use the [REST API](https://openvidu.io/3.8/meet/embedded/reference/rest-api/index.md) to [embed OpenVidu Meet](https://openvidu.io/3.8/meet/embedded/intro) using:
