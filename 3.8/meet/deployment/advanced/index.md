# Scalable and fault-tolerant Meet deployments
...
OpenVidu Meet can be easily deployed in a single server (follow the [basic deployment guide](https://openvidu.io/3.8/meet/deployment/basic/index.md)). However, a single server won't be enough for environments that require scalability and high-availability. For such cases, it is necessary a multi-node deployment.
...
| **Installation instructions** | [Try](https://openvidu.io/3.8/meet/deployment/local/index.md)                                                                                                         | [Install](https://openvidu.io/3.8/meet/deployment/basic/index.md)                                                                                                                        | [Install](https://openvidu.io/3.8/docs/self-hosting/elastic/index.md)                                         | [Install](https://openvidu.io/3.8/docs/self-hosting/ha/index.md)         |

Info

You can learn more about the **OpenVidu\*\*\*\*COMMUNITY** and **OpenVidu\*\*\*\*PRO** editions [here](https://openvidu.io/3.8/meet/deployment/overview/#openvidu-meet-editions).

### OpenVidu Local (development)

Run the OpenVidu Local deployment in your machine by following [this guide](https://openvidu.io/3.8/meet/deployment/local/index.md).
...
You can install OpenVidu Meet as a Single Node deployment by following the [basic deployment guide](https://openvidu.io/3.8/meet/deployment/basic/index.md). You can also check out the [OpenVidu Platform documentation](https://openvidu.io/3.8/docs/self-hosting/single-node/index.md) for more detailed installation options.
...
Install OpenVidu Elastic by following the [OpenVidu Platform guide](https://openvidu.io/3.8/docs/self-hosting/elastic/index.md).
...
Install OpenVidu High Availability by following the [OpenVidu Platform guide](https://openvidu.io/3.8/docs/self-hosting/ha/index.md).
