...
| Media engine            | PionCOMMUNITY or [**mediasoup**](https://openvidu.io/3.8/docs/self-hosting/production-ready/performance/index.md) (~2x more efficient)PRO                                                           | Pion                                              |
| Autoscaling             | Yes: [Elastic](https://openvidu.io/3.8/docs/self-hosting/elastic/index.md) & [HA](https://openvidu.io/3.8/docs/self-hosting/ha/index.md) modesPRO                                                   | Autoscaling is yours to build and operate         |
| License                 | Apache 2.0COMMUNITY / commercialPRO                                                                                                                                                                 | Apache 2.0                                        |
| Egress/Ingress          | [Bundled by default](https://openvidu.io/3.8/docs/developing-your-openvidu-app/how-to/index.md)COMMUNITY                                                                                            | Separate services you deploy and operate yourself |
...
| Dashboard               | [OpenVidu Dashboard](https://openvidu.io/3.8/docs/self-hosting/production-ready/observability/openvidu-dashboard/index.md)COMMUNITY, with detailed per-room and per-participant viewsPRO            | No                                                |
...
- [**Egress and Ingress**](https://openvidu.io/3.8/docs/developing-your-openvidu-app/how-to/index.md) — no separate deployment step.
