...
- Improved [OpenVidu Local Deployment](https://openvidu.io/3.0/docs/self-hosting/local/):
  ...
  - WebHooks ([LiveKit reference](https://docs.livekit.io/home/server/webhooks/) ) supported against a local [OpenVidu Call](https://openvidu.io/3.0/docs/openvidu-call/docs/#run-openvidu-locally).
