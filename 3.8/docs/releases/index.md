...
For the Release Notes of OpenVidu Meet 3.8.0, please visit here: [OpenVidu Meet 3.8.0](https://openvidu.io/3.8/meet/releases/#380)
...
- **Deployment improvements**:
  ...
  - The Promtail service of OpenVidu's [observability stack](https://openvidu.io/3.8/docs/self-hosting/production-ready/observability/) has been replaced by [Alloy](https://grafana.com/docs/alloy/latest/) . Promtail has been deprecated and Alloy is now the recommended log collector for OpenVidu deployments.
...
For the Release Notes of OpenVidu Meet 3.7.0, please visit here: [OpenVidu Meet 3.7.0](https://openvidu.io/3.7/meet/releases/#370)
...
For the Release Notes of OpenVidu Meet 3.6.0, please visit here: [OpenVidu Meet 3.6.0](https://openvidu.io/3.6/meet/releases/#360)
...
- **New cloud providers for Live Captions**: we have also expanded the collection of supported third-party AI [cloud providers](https://openvidu.io/3.6/docs/ai/live-captions/#cloud-providers): [MistralAI](https://mistral.ai/) , [NVIDIA Riva](https://developer.nvidia.com/topics/ai/generative-ai/riva) , [Spitch](https://spitch.app/) , [ElevenLabs](https://elevenlabs.io/) , [Simplismart](https://www.simplismart.ai/) .
...
For the Release Notes of OpenVidu Meet 3.5.0, please visit here: [OpenVidu Meet 3.5.0](https://openvidu.io/3.5/meet/releases/#350)
...
- **Live Captions**:
  ...
  - Added [Cartesia](https://www.cartesia.ai/sonic) and [Soniox](https://soniox.com/) to the list of [supported AI providers](https://openvidu.io/3.5/docs/ai/live-captions/#supported-ai-providers).
...
For the Release Notes of OpenVidu Meet 3.4.0, please visit here: [OpenVidu Meet 3.4.0](https://openvidu.io/3.4/meet/releases/#340)
...
- **AI Services**: OpenVidu now supports a catalog of AI services that can be easily integrated into your application to enhance the user experience and add advanced features. These services are delivered through **OpenVidu agents**: a set of pre-configured and ready-to-use AI modules that seamlessly integrate into your Rooms.
  ...
  Of course, you can also implement your own custom agents using the powerful [LiveKit Agents framework](https://docs.livekit.io/agents/) and deploy it along your OpenVidu deployment. Any LiveKit agent is compatible with OpenVidu. Learn how to do so [here](https://openvidu.io/3.3/docs/ai/custom-agents/).
...
- [mediasoup](https://openvidu.io/3.0/docs/self-hosting/production-ready/performance/) support:
  - Dynacast is now supported ([LiveKit reference](https://docs.livekit.io/transport/media/publish/) ).
...
- Improved [OpenVidu Local Deployment](https://openvidu.io/3.0/docs/self-hosting/local/):
  ...
  - WebHooks ([LiveKit reference](https://docs.livekit.io/intro/basics/rooms-participants-tracks/webhooks-events/) ) supported against a local [OpenVidu Call](https://openvidu.io/3.0/docs/openvidu-call/docs/#run-openvidu-locally).
...
- When using [mediasoup](https://openvidu.io/3.0/docs/self-hosting/production-ready/performance/):
  ...
  - No `ConnectionQualityChanged` event ([LiveKit reference](https://docs.livekit.io/intro/basics/rooms-participants-tracks/webhooks-events/#sdk-events) ).
  - No support for Dynacast ([LiveKit reference](https://docs.livekit.io/transport/media/publish/) ).
