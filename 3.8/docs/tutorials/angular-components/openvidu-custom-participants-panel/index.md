...
[Source code](https://github.com/OpenVidu/openvidu-tutorials/tree/3.8.0/openvidu-components-angular/openvidu-custom-participants-panel)
...
1. Navigate into the application client directory:
   ...
   ```bash
     cd openvidu-tutorials/openvidu-components-angular/openvidu-custom-participants-panel
   ```
