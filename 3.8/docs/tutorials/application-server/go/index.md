...
[main.go](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/go/main.go#L15-L17)
...
[main.go](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/go/main.go#L63-L70)
...
[main.go](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/go/main.go#L19-L49)
...
1. We set the video grants and identity of the participant in the AccessToken. `RoomJoin` allows the user to join a room and `Room` determines the specific room. Check out all [Video Grants](https://openvidu.io/3.8/docs/reference/access-tokens/#video-grants).
...
[main.go](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/go/main.go#L51-L61)
...
1. Receive the webhook event providing the `http.Request` in the Gin context and the `SimpleKeyProvider` we just created. This will validate and decode the incoming [webhook event](https://openvidu.io/3.8/docs/reference/webhooks/index.md).
