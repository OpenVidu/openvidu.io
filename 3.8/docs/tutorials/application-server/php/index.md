...
[index.php](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/php/index.php#L1-L17)
...
[index.php](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/php/index.php#L19-L43)
...
1. Create a `VideoGrant` object setting the necessary video grants options. `setRoomJoin` allows the user to join a room and `setRoomName` determines the specific room. Check out all [Video Grants](https://openvidu.io/3.8/docs/reference/access-tokens/#video-grants).
...
[index.php](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/php/index.php#L45-L62)
...
1. Create a new `WebhookReceiver` object providing the `LIVEKIT_API_KEY` and `LIVEKIT_API_SECRET`. It will help validating and decoding incoming [webhook events](https://openvidu.io/3.8/docs/reference/webhooks/index.md).
