...
It also initializes the `WebhookReceiver` object that will help validating and decoding incoming [webhook events](https://openvidu.io/3.8/docs/reference/webhooks/index.md).
