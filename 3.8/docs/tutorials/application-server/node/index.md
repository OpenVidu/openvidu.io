...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/node/index.js#L1-L14)
...
It also imports the `WebhookReceiver` class, used further down to validate and decode incoming [webhook events](https://openvidu.io/3.8/docs/reference/webhooks/index.md).
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/node/index.js#L16-L31)
...
1. We set the video grants in the AccessToken. `roomJoin` allows the user to join a room and `room` determines the specific room. Check out all [Video Grants](https://openvidu.io/3.8/docs/reference/access-tokens/#video-grants).
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/application-server/node/index.js#L33-L49)
