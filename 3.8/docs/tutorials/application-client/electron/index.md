...
- `app.js`: This file constitutes the renderer process code, responsible for the application UI and logic. It uses the [LiveKit JS SDK](https://docs.livekit.io/client-sdk-js) to connect to the LiveKit server and interact with the video call room.
