...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.8.0/advanced-features/openvidu-recording-basic-node-azure)

This tutorial is a simple video-call application, built upon [Node.js server](https://openvidu.io/3.8/docs/tutorials/application-server/node/index.md) and [JavaScript client](https://openvidu.io/3.8/docs/tutorials/application-client/javascript/index.md) tutorials, and extends them by adding recording capabilities:
...
1. Deploy OpenVidu Single Node in Azure following these instructions [to deploy in Azure](https://openvidu.io/3.8/docs/self-hosting/single-node/azure/install/index.md).
...
1. Point the tutorial to your Azure deployment:
   ...
   - Modify file [`app.js`](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/public/app.js#L3) to update the value of `LIVEKIT_URL` to `wss://your.azure.deployment.domain`
...
The server application extends the [Node.js server tutorial](https://openvidu.io/3.8/docs/tutorials/application-server/node/index.md) by adding the following REST API endpoints:
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/index.js#L15-L26)
...
It also initializes the `EgressClient`, which will help interacting with [Egress API](https://openvidu.io/3.8/docs/reference/egress/index.md) to manage recordings, and the `AzureBlobStorageService`, which will help interacting with the Blob Container:

[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/index.js#L33-L38)
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/index.js#L45-L62)
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/index.js#L79-L117)
...
1. Define the file path where the recording will be stored. The `{room_name}`, `{time}` and `{room_id}` templates will be replaced by the actual room name, timestamp and room ID, respectively. Check out all available [filename templates](https://openvidu.io/3.8/docs/reference/egress/#filenames).
...
1. Check if there is already an active recording for the room. If there is, it returns a `409` error to prevent starting a new recording. To accomplish this, we use the `getActiveRecordingByRoom` function, which lists all active egresses for a specified room by calling the `listEgress` method of the `EgressClient` with the `roomName` and `active` parameters, and then returns the egress ID of the first active egress found:
   ...
   [index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/index.js#L231-L240)
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/index.js#L120-L148)
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node/src/index.js#L152-L173)
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/index.js#L173-L203)
...
1. Gets the requested range of the recording file by calling the `getRecordingStream` function:
   ...
   [index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/index.js#L242-L255)
...
[index.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/index.js#L206-L222)
...
[azure.blobstorage.service.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/src/azure.blobstorage.service.js)
...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/public/app.js#L20-L87)
...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/public/app.js#L337-L370)
...
>
> In the [advanced recording tutorial](https://openvidu.io/3.8/docs/tutorials/advanced-features/recording-advanced-azure/index.md), we show how to implement a custom notification system that alerts all participants of a recording's deletion by sending data messages.
...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/public/app.js#L372-L379)
...
[index.html](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.8.0/advanced-features/openvidu-recording-basic-node-azure/public/index.html#L94-L99)
