...
It also initializes the `EgressClient`, which will help interacting with [Egress API](https://docs.livekit.io/home/egress/api/) to manage recordings, and the `S3Service`, which will help interacting with the S3 bucket:
