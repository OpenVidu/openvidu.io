...
[Get started](https://openvidu.io/3.8/docs/getting-started/index.md) [Start with a tutorial](https://openvidu.io/3.8/docs/tutorials/application-server/index.md) [Build your app](https://openvidu.io/3.8/docs/build-your-app/index.md)
...
[Build your first app — tutorials in 8 languages](https://openvidu.io/3.8/docs/tutorials/application-server/index.md) [Run OpenVidu locally](https://openvidu.io/3.8/docs/self-hosting/local/index.md)
