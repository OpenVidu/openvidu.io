...
- **S3 compatible storage for Egress recordings**: OpenVidu Community comes with an S3 compatible storage already configured to store [Egress](https://openvidu.io/3.8/docs/reference/egress/index.md) recordings ([Minio](https://min.io/) ).
