...
| Spitch       | `spitch`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Spitch Speech To Text API](https://docs.spitch.app/api/speech/stt) . Specialized in African languages                                                            |                 |
