...
| ----------- | ------------------------ | -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
|             | `aws`                    | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Amazon Transcribe](https://aws.amazon.com/transcribe/)                                                                                                           |                 |
|             | `azure`                  | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Azure Speech service](https://learn.microsoft.com/azure/ai-services/speech-service/index-speech-to-text)                                                         |                 |
|             | `azure_openai`           | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-foundry/models/openai/)                                                                              |                 |
|             | `google`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Google Cloud Speech-to-Text](https://cloud.google.com/speech-to-text)                                                                                            |                 |
|             | `openai`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [OpenAI Speech to text](https://developers.openai.com/api/docs/guides/speech-to-text)                                                                             |                 |
|             | `groq`                   | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Groq Speech](https://console.groq.com/docs/speech-to-text)                                                                                                       |                 |
|             | `deepgram`               | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Deepgram Speech-to-Text API](https://deepgram.com/product/speech-to-text)                                                                                        |                 |
|             | `assemblyai`             | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [AssemblyAI Speech-to-Text API](https://www.assemblyai.com/products/speech-to-text)                                                                               |                 |
|             | `fal`                    | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Fal Speech-to-Text API](https://fal.ai/docs/examples/audio-speech/convert-speech-to-text)                                                                        |                 |
|             | `clova`                  | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Naver Clova Speech Recognition](https://api.ncloud-docs.com/docs/en/ai-naver-clovaspeechrecognition-stt) . Specialized in Japanese, Korean and Chinese languages |                 |
|             | `speechmatics`           | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Speechmatics Real-Time API](https://docs.speechmatics.com/speech-to-text/realtime/quickstart)                                                                    |                 |
|             | `gladia`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Gladia Speech-to-Text API](https://www.gladia.io/product/async-transcription)                                                                                    |                 |
|             | `sarvam`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Sarvam Speech-to-Text API](https://docs.sarvam.ai/api-reference/speech-to-text/transcribe) . Optimized for Indian languages                                      |                 |
|             | `mistralai`              | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Voxtral](https://mistral.ai/news/voxtral/)                                                                                                                       |                 |
|             | `cartesia`               | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Cartesia Ink-Whisper](https://www.cartesia.ai/ink)                                                                                                               |                 |
|             | `soniox`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Soniox Speech-to-Text API](https://soniox.com/speech-to-text)                                                                                                    |                 |
|             | `nvidia`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [NVIDIA Riva ASR](https://docs.nvidia.com/deeplearning/riva/user-guide/docs/asr/asr-overview.html)                                                                |                 |
|             | `spitch`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Spitch Speech To Text API](https://docs.spitch.app/) . Specialized in African languages                                                                          |                 |
|             | `elevenlabs`             | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [ElevenLabs Speech To Text API](https://elevenlabs.io/speech-to-text)                                                                                             |                 |
|             | `simplismart`            | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Simplismart](https://www.simplismart.ai/)                                                                                                                        |                 |
