...
Live Captions are received in your frontend application using the [Text Stream API](https://docs.livekit.io/home/client/data/text-streams/#handling-incoming-streams) of LiveKit client SDKs. You must specifically subscribe to the Room topic **`lk.transcription`** to automatically receive transcription events. For example, in JavaScript:
...
Refer to [LiveKit documentation](https://docs.livekit.io/agents/voice-agent/transcriptions/#frontend-integration) to see how to handle transcription events in other frontend platforms.
...
| Azure OpenAI | `azure_openai`           | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service/)                                                                            |                 |
...
| OpenAI       | `openai`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [OpenAI Speech to text](https://platform.openai.com/docs/guides/speech-to-text)                                                                                   |                 |
...
| Fal          | `fal`                    | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Fal Speech-to-Text API](https://docs.fal.ai/guides/convert-speech-to-text/)                                                                                      |                 |
...
| Speechmatics | `speechmatics`           | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Speechmatics Real-Time API](https://docs.speechmatics.com/introduction/rt-guide)                                                                                 |                 |
...
| Sarvam       | `sarvam`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Sarvam Speech-to-Text API](https://docs.sarvam.ai/api-reference-docs/speech-to-text/transcribe) . Optimized for Indian languages                                 |                 |
| MistralAI    | `mistralai`              | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Voxtral](https://mistral.ai/news/voxtral)                                                                                                                        |                 |
| Cartesia     | `cartesia`               | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Cartesia Ink-Whisper](https://cartesia.ai/ink)                                                                                                                   |                 |
...
| Simplismart  | `simplismart`            | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Simplismart](https://simplismart.ai/)                                                                                                                            |                 |
