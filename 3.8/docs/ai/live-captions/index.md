...
[Enable the Speech Processing agent](https://openvidu.io/3.8/docs/ai/openvidu-agents/speech-processing-agent/#enable-the-agent-and-configure-ai-services)

You configure the Live Captions service by setting up the following properties when [modifying file `agent-speech-processing.yaml`](https://openvidu.io/3.8/docs/ai/openvidu-agents/speech-processing-agent/#2-modify-file-agent-speech-processingyaml):

<a href='https://github.com/OpenVidu/openvidu-agents/blob/3.8.0/speech-processing/agent-speech-processing.yaml' target='_blank'>agent-speech-processing.yaml</a>
...
- **Manual processing**: the agent will connect to new Rooms only when your application dictates it with [explicit agent dispatch](https://openvidu.io/3.8/docs/ai/openvidu-agents/agent-dispatch/#explicit-agent-dispatch). This allows you to toggle Live Captions service on demand for specific Rooms. Set YAML property `live_captions.processing` to `manual` in file [`agent-speech-processing.yaml`](#how-to-enable-live-captions-service-in-your-openvidu-deployment).

Learn more about [Automatic vs Manual processing](https://openvidu.io/3.8/docs/ai/openvidu-agents/agent-dispatch/index.md).
...
| ------------ | ------------------------ | -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| AWS          | `aws`                    | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Amazon Transcribe](https://aws.amazon.com/transcribe/)                                                                                                           |                 |
| Azure        | `azure`                  | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Azure Speech service](https://learn.microsoft.com/azure/ai-services/speech-service/index-speech-to-text)                                                         |                 |
| Azure OpenAI | `azure_openai`           | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-foundry/models/openai/)                                                                              |                 |
| Google Cloud | `google`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Google Cloud Speech-to-Text](https://cloud.google.com/speech-to-text)                                                                                            |                 |
| OpenAI       | `openai`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [OpenAI Speech to text](https://developers.openai.com/api/docs/guides/speech-to-text)                                                                             |                 |
| Groq         | `groq`                   | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Groq Speech](https://console.groq.com/docs/speech-to-text)                                                                                                       |                 |
| Deepgram     | `deepgram`               | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Deepgram Speech-to-Text API](https://deepgram.com/product/speech-to-text)                                                                                        |                 |
| AssemblyAI   | `assemblyai`             | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [AssemblyAI Speech-to-Text API](https://www.assemblyai.com/products/speech-to-text)                                                                               |                 |
| Fal          | `fal`                    | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Fal Speech-to-Text API](https://fal.ai/docs/examples/audio-speech/convert-speech-to-text)                                                                        |                 |
| Clova        | `clova`                  | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Naver Clova Speech Recognition](https://api.ncloud-docs.com/docs/en/ai-naver-clovaspeechrecognition-stt) . Specialized in Japanese, Korean and Chinese languages |                 |
| Speechmatics | `speechmatics`           | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Speechmatics Real-Time API](https://docs.speechmatics.com/speech-to-text/realtime/quickstart)                                                                    |                 |
| Gladia       | `gladia`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Gladia Speech-to-Text API](https://www.gladia.io/product/async-transcription)                                                                                    |                 |
| Sarvam       | `sarvam`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Sarvam Speech-to-Text API](https://docs.sarvam.ai/api-reference/speech-to-text/transcribe) . Optimized for Indian languages                                      |                 |
| MistralAI    | `mistralai`              | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Voxtral](https://mistral.ai/news/voxtral/)                                                                                                                       |                 |
| Cartesia     | `cartesia`               | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Cartesia Ink-Whisper](https://www.cartesia.ai/ink)                                                                                                               |                 |
| Soniox       | `soniox`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Soniox Speech-to-Text API](https://soniox.com/speech-to-text)                                                                                                    |                 |
| Nvidia       | `nvidia`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [NVIDIA Riva ASR](https://docs.nvidia.com/deeplearning/riva/user-guide/docs/asr/asr-overview.html)                                                                |                 |
| Spitch       | `spitch`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Spitch Speech To Text API](https://docs.spitch.app/) . Specialized in African languages                                                                          |                 |
| ElevenLabs   | `elevenlabs`             | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [ElevenLabs Speech To Text API](https://elevenlabs.io/speech-to-text)                                                                                             |                 |
| Simplismart  | `simplismart`            | `docker.io/openvidu/agent-speech-processing-cloud:3.8.0` | Uses [Simplismart](https://www.simplismart.ai/)                                                                                                                        |                 |
...
The default Docker image `docker.io/openvidu/agent-speech-processing-vosk:3.8.0` comes with small-sized models for multiple languages pre-installed. You can build your own Docker image with exactly the models you need (<https://alphacephei.com/vosk/models>).
...
Sherpa live captions provider is part of **OpenVidu** **PRO**. Before deploying, you need to [create an OpenVidu account](https://openvidu.io/3.8/account/index.md) to get your license key. There's a 15-day free trial waiting for you!
...
The default Docker image `docker.io/openvidu/agent-speech-processing-sherpa:3.8.0` comes with small-sized models for multiple languages pre-installed. You can build your own Docker image with exactly the models you need ([sherpa-onnx ASR models](https://github.com/k2-fsa/sherpa-onnx/releases/tag/asr-models) ).
...
- The OpenVidu node running the Speech Processing agent must have an **NVIDIA GPU whose driver supports CUDA 12 or higher (driver >= 525)** with the appropriate [NVIDIA Container Toolkit](https://docs.nvidia.com/datacenter/cloud-native/container-toolkit/latest/install-guide.html) installed.
...
Check out the [Live Captions tutorial](https://openvidu.io/3.8/docs/tutorials/ai-services/openvidu-live-captions/index.md) for a complete example.
