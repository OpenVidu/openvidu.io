...
1. Confirm the new shape and [start](#start-openvidu-single-node-pro) the instance again.
...
1. Scroll down to *"Versions"* and click on *"Create secret version"* to add a new version with the updated value. Create Secret Version
1. Enter the new secret value and click on *"Create secret version"*. Create Secret Version
