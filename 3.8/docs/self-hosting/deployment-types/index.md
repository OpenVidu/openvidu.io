...
| **Installation instructions** | [Install](https://openvidu.io/3.8/docs/self-hosting/local/index.md)                                                                                                   | [Install](https://openvidu.io/3.8/docs/self-hosting/single-node/index.md)                                                                                                                | [Install](https://openvidu.io/3.8/docs/self-hosting/elastic/index.md)                                         | [Install](https://openvidu.io/3.8/docs/self-hosting/ha/index.md)         |
...
- **OpenVidu Single Node** **PRO**: for users who want the benefits of OpenVidu PRO in a single-node setup. It includes **2x performance** and **advanced observability** features.
...
| **Minio**                                                  | S3 bucket used to store recordings and common node configurations. In [OpenVidu High Availability](#openvidu-high-availability) this is an instance of a [Minio Multi-Node](https://docs.min.io/aistor/installation/linux/) .                                         |
...
| **Egress Server**              | Module used to export media from a Room (for example, recordings or RTMP broadcasting). See [Egress](https://openvidu.io/3.8/docs/reference/egress/index.md).  |
| **Ingress Server**             | Module used to import media into a Room (for example, an MP4 video or an RTSP stream). See [Ingress](https://openvidu.io/3.8/docs/reference/ingress/index.md). |
| **Agents**                     | Modules used to add AI capabilities to Rooms. See [AI Services](https://openvidu.io/3.8/docs/ai/overview/index.md).                                            |
