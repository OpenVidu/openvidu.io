...
It is a web application designed to provide **OpenVidu administrators** with a comprehensive view of **usage statistics** and **real-time monitoring** of video **Rooms**. OpenVidu Dashboard is included by default in any [OpenVidu deployment](https://openvidu.io/3.8/docs/self-hosting/deployment-types/index.md).
...
Analytics page of OpenVidu Dashboard with client SDK and connection charts

Bandwidth usage charts in the OpenVidu Dashboard analytics page

Participant and room charts in the OpenVidu Dashboard analytics page

Egress charts in the OpenVidu Dashboard analytics page
...
OpenVidu Dashboard listing with an active room

Room details page with duration, bandwidth and participants

Timeline and related egresses in the room details page
...
Participant details page with duration and bandwidth usage

Audio and video quality scores in the participant details page
...
Egress details page with duration, status and type

Destination and room information in the egress details page
