...
To find the command, go to [Compute Engine Instances](https://console.cloud.google.com/compute/instances) {:target="*blank"}, click the arrow next to **SSH**, and then click* "View gcloud command"\_.
