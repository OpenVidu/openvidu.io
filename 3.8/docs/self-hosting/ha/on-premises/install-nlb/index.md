...
If you want to force all traffic including WebRTC to go through the Load Balancer, check the [Force media traffic through port 443](https://openvidu.io/3.8/docs/self-hosting/how-to-guides/force-single-port/index.md) guide.
...
Once you have OpenVidu deployed, you can check the [Administration](https://openvidu.io/3.8/docs/self-hosting/ha/on-premises/admin/index.md) section to learn how to manage your OpenVidu High Availability deployment.
