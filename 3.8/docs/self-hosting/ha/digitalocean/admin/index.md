...
1. Click on *"Upsize"* and select the Droplet size you desire and click on *"Resize"* Change droplet size master 1
...
1. Upload the edited `secrets.env` to the bucket, select private file and replace it. Secrets.env upload Secrets.env replace
