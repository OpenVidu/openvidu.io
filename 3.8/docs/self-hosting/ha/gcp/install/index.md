...
For more details, you can check the [variables.tf](https://github.com/OpenVidu/openvidu/blob/v3.8.0/openvidu-deployment/pro/ha/gcp/variables.tf) file to see additional information about the inputs.
