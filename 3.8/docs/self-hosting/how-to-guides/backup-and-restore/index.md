...
- **S3/Object storage providers**
  ...
  - Google Cloud Storage: implement [Object Versioning and Retention](https://docs.cloud.google.com/storage/docs/object-versioning)

- **MongoDB providers**

  - MongoDB Atlas: [Cloud backups and snapshots](https://www.mongodb.com/docs/atlas/backup/cloud-backup/snapshot-management/)
  - AWS DocumentDB: [DocumentDB Backups and snapshots](https://docs.aws.amazon.com/documentdb/latest/devguide/backup_restore.html)
