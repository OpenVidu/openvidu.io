...
- **TCP relay denial**: TCP relay allocations ([RFC 6062](https://datatracker.ietf.org/doc/html/rfc6062)) are explicitly denied, limiting TURN to its intended use for UDP media relay.
