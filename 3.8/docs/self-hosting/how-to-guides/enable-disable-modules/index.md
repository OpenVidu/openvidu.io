...
These configurations should be valid just by copying and pasting them into the `livekit.yaml` file. If you want to understand the `${openvidu.VARIABLE:?mandatory}` syntax, please refer to the [Configuration](https://openvidu.io/3.8/docs/self-hosting/configuration/in-depth/index.md) section.
