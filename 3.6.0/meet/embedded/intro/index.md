...
## Where to start? We recommend following the [**step by step guide**](https://openvidu.io/3.6.0/meet/embedded/step-by-step-guide) or exploring one of our [**tutorials**](https://openvidu.io/3.6.0/meet/embedded/tutorials).
