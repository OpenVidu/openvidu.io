...
This local deployment is the ideal choice to develop the [embedding of OpenVidu Meet into your own application](https://openvidu.io/3.4.1/meet/embedded/intro/index.md).

Warning

Remember that this deployment is designed for **demo** and **development** purposes. For production follow the [Basic deployment](https://openvidu.io/3.4.1/meet/deployment/basic/index.md) or [Advanced deployments](https://openvidu.io/3.4.1/meet/deployment/advanced/index.md).
...
You can use the [REST API](https://openvidu.io/3.4.1/meet/embedded/reference/rest-api/index.md) to [embed OpenVidu Meet](https://openvidu.io/3.4.1/meet/embedded/intro) using:

- API Key: `meet-api-key`

You can change them later from the [OpenVidu Meet Users And Permissions](https://openvidu.io/3.4.1/meet/features/users-and-permissions/#modify-openvidu-meet-authentication).
...
If you want to modify some configurations or have more control over the local deployment, you can deploy the [OpenVidu Platform Local deployment](https://openvidu.io/3.4.1/docs/self-hosting/local/index.md) which by default includes **OpenVidu Meet** as one of its services.
