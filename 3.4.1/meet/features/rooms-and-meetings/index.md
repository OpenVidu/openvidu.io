...
\[[](../../../assets/videos/meet/meet-rooms-dark.mp4#only-dark)\](https://openvidu.io/3.4.1/assets/videos/meet/meet-rooms-dark.mp4) \[[](../../../assets/videos/meet/meet-rooms-light.mp4#only-light)\](https://openvidu.io/3.4.1/assets/videos/meet/meet-rooms-light.mp4)
...
- Share room links with different permissions (see [Users and permissions](https://openvidu.io/3.4.1/meet/features/users-and-permissions/index.md)).

\[[](../../../assets/videos/meet/room-actions-dark.mp4#only-dark)\](https://openvidu.io/3.4.1/assets/videos/meet/room-actions-dark.mp4) \[[](../../../assets/videos/meet/room-actions-light.mp4#only-light)\](https://openvidu.io/3.4.1/assets/videos/meet/room-actions-light.mp4)
...
\[[](../../../assets/videos/meet/bulk-delete-rooms.mp4)\](https://openvidu.io/3.4.1/assets/videos/meet/bulk-delete-rooms.mp4)
...
Each room has different room links, each one granting access to the room with a specific participant role. See [Participant roles in a meeting](https://openvidu.io/3.4.1/meet/features/users-and-permissions/#participant-roles-in-a-meeting) for more information.

#### Get a room link from the "Rooms" page

Every room item allows sharing the room link for every participant role.

\[[](../../../assets/videos/meet/share-room-link.mp4)\](https://openvidu.io/3.4.1/assets/videos/meet/share-room-link.mp4)
...
Every possible action against a room can be done through [OpenVidu Meet REST API](https://openvidu.io/3.4.1/meet/embedded/reference/rest-api/index.md):

| Operation          | HTTP Method | Reference                                                                                            |
| ------------------ | ----------- | ---------------------------------------------------------------------------------------------------- |
| Create a room      | POST        | [Reference](https://openvidu.io/3.4.1/meet/embedded/reference/api.html#/operations/createRoom)       |
| Get a room         | GET         | [Reference](https://openvidu.io/3.4.1/meet/embedded/reference/api.html#/operations/getRoom)          |
| Get all rooms      | GET         | [Reference](https://openvidu.io/3.4.1/meet/embedded/reference/api.html#/operations/getRooms)         |
| Delete a room      | DELETE      | [Reference](https://openvidu.io/3.4.1/meet/embedded/reference/api.html#/operations/deleteRoom)       |
| Bulk delete rooms  | DELETE      | [Reference](https://openvidu.io/3.4.1/meet/embedded/reference/api.html#/operations/bulkDeleteRooms)  |
| Get room config    | GET         | [Reference](https://openvidu.io/3.4.1/meet/embedded/reference/api.html#/operations/getRoomConfig)    |
| Update room config | PUT         | [Reference](https://openvidu.io/3.4.1/meet/embedded/reference/api.html#/operations/updateRoomConfig) |
...
\[[](../../../assets/videos/meet/join-meeting.mp4)\](https://openvidu.io/3.4.1/assets/videos/meet/join-meeting.mp4)
...
\[[](../../../assets/videos/meet/device-view-dark.mp4#only-dark)\](https://openvidu.io/3.4.1/assets/videos/meet/device-view-dark.mp4) \[[](../../../assets/videos/meet/device-view-light.mp4#only-light)\](https://openvidu.io/3.4.1/assets/videos/meet/device-view-light.mp4)
...
Recordings can also be accessed from the "Recordings" page in OpenVidu Meet, even after the meeting has ended. See [Managing recordings](https://openvidu.io/3.4.1/meet/features/recordings/#managing-recordings).
