...
Direct links accept the same **attributes** as the OpenVidu Meet Web Component. See [Web Component Attributes](https://openvidu.io/3.4.0/meet/embedded/reference/webcomponent/#attributes) for the full list and descriptions.
...
Direct links do not support programmatic commands since the meeting opens in a separate browser tab/window. If you need to control the meeting programmatically, consider using the [Web Component](https://openvidu.io/3.4.0/meet/embedded/reference/webcomponent/index.md) or [Iframe](https://openvidu.io/3.4.0/meet/embedded/reference/iframe/index.md) approaches instead.

### Events

Direct links do not emit events to your application since the meeting runs in a separate browser context. If you need to listen to meeting events, consider using the [Web Component](https://openvidu.io/3.4.0/meet/embedded/reference/webcomponent/index.md) or [Iframe](https://openvidu.io/3.4.0/meet/embedded/reference/iframe/index.md) approaches instead.
