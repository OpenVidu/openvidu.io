...
[Enable the Speech Processing agent](https://openvidu.io/3.7/docs/ai/openvidu-agents/speech-processing-agent/#enable-the-agent-and-configure-ai-services)

You configure the Live Captions service by setting up the following properties when [modifying file `agent-speech-processing.yaml`](https://openvidu.io/3.7/docs/ai/openvidu-agents/speech-processing-agent/#2-modify-file-agent-speech-processingyaml):

[agent-speech-processing.yaml](https://github.com/OpenVidu/openvidu-agents/blob/3.7.0/speech-processing/agent-speech-processing.yaml)
...
- **Manual processing**: the agent will connect to new Rooms only when your application dictates it with [explicit agent dispatch](https://openvidu.io/3.7/docs/ai/openvidu-agents/agent-dispatch/#explicit-agent-dispatch). This allows you to toggle Live Captions service on demand for specific Rooms. Set YAML property `live_captions.processing` to `manual` in file [`agent-speech-processing.yaml`](#how-to-enable-live-captions-service-in-your-openvidu-deployment).

Learn more about [Automatic vs Manual processing](https://openvidu.io/3.7/docs/ai/openvidu-agents/agent-dispatch/index.md).
...
| ----------- | ------------------------ | -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
|             | `aws`                    | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Amazon Transcribe](https://aws.amazon.com/transcribe/)                                                                                                           |                 |
|             | `azure`                  | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Azure Speech service](https://learn.microsoft.com/azure/ai-services/speech-service/index-speech-to-text)                                                         |                 |
|             | `azure_openai`           | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service/)                                                                            |                 |
|             | `google`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Google Cloud Speech-to-Text](https://cloud.google.com/speech-to-text)                                                                                            |                 |
|             | `openai`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [OpenAI Speech to text](https://platform.openai.com/docs/guides/speech-to-text)                                                                                   |                 |
|             | `groq`                   | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Groq Speech](https://console.groq.com/docs/speech-to-text)                                                                                                       |                 |
|             | `deepgram`               | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Deepgram Speech-to-Text API](https://deepgram.com/product/speech-to-text)                                                                                        |                 |
|             | `assemblyai`             | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [AssemblyAI Speech-to-Text API](https://www.assemblyai.com/products/speech-to-text)                                                                               |                 |
|             | `fal`                    | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Fal Speech-to-Text API](https://docs.fal.ai/guides/convert-speech-to-text/)                                                                                      |                 |
|             | `clova`                  | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Naver Clova Speech Recognition](https://api.ncloud-docs.com/docs/en/ai-naver-clovaspeechrecognition-stt) . Specialized in Japanese, Korean and Chinese languages |                 |
|             | `speechmatics`           | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Speechmatics Real-Time API](https://docs.speechmatics.com/introduction/rt-guide)                                                                                 |                 |
|             | `gladia`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Gladia Speech-to-Text API](https://www.gladia.io/product/async-transcription)                                                                                    |                 |
|             | `sarvam`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Sarvam Speech-to-Text API](https://docs.sarvam.ai/api-reference-docs/speech-to-text/transcribe) . Optimized for Indian languages                                 |                 |
|             | `mistralai`              | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Voxtral](https://mistral.ai/news/voxtral)                                                                                                                        |                 |
|             | `cartesia`               | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Cartesia Ink-Whisper](https://cartesia.ai/ink)                                                                                                                   |                 |
|             | `soniox`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Soniox Speech-to-Text API](https://soniox.com/speech-to-text)                                                                                                    |                 |
|             | `nvidia`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [NVIDIA Riva ASR](https://docs.nvidia.com/deeplearning/riva/user-guide/docs/asr/asr-overview.html)                                                                |                 |
|             | `spitch`                 | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Spitch Speech To Text API](https://docs.spitch.app/api/speech/stt) . Specialized in African languages                                                            |                 |
|             | `elevenlabs`             | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [ElevenLabs Speech To Text API](https://elevenlabs.io/speech-to-text)                                                                                             |                 |
|             | `simplismart`            | `docker.io/openvidu/agent-speech-processing-cloud:3.7.0` | Uses [Simplismart](https://simplismart.ai/)                                                                                                                            |                 |
...
The default Docker image `docker.io/openvidu/agent-speech-processing-vosk:3.7.0` comes with small-sized models for multiple languages pre-installed. You can build your own Docker image with exactly the models you need (<https://alphacephei.com/vosk/models>).

1. Create this two-line Dockerfile:

   ```Dockerfile
   FROM docker.io/openvidu/agent-speech-processing-vosk-base:3.7.0
...
1. In file [`agent-speech-processing.yaml`](#how-to-enable-live-captions-service-in-your-openvidu-deployment) set properties `docker_image` and `live_captions.provider` as follows:
   ...
   ```yaml
   docker_image: docker.io/openvidu/agent-speech-processing-sherpa:3.7.0
   live_captions:
     provider: sherpa
   ```
...
The default Docker image `docker.io/openvidu/agent-speech-processing-sherpa:3.7.0` comes with small-sized models for multiple languages pre-installed. You can build your own Docker image with exactly the models you need ([sherpa-onnx ASR models](https://github.com/k2-fsa/sherpa-onnx/releases/tag/asr-models) ).

1. Create this two-line Dockerfile:

   ```Dockerfile
   FROM docker.io/openvidu/agent-speech-processing-sherpa-base:3.7.0
   ...
   >
   > - `FROM docker.io/openvidu/agent-speech-processing-sherpa-cuda11-base:3.7.0` if your GPU is compatible only with CUDA 11.
   > - `FROM docker.io/openvidu/agent-speech-processing-sherpa-cuda12-base:3.7.0` if your GPU is compatible with CUDA 12 or higher.
...
```yaml
docker_image: docker.io/openvidu/agent-speech-processing-sherpa-cuda12:3.7.0 #(1)!
...
Check out the [Live Captions tutorial](https://openvidu.io/3.7/docs/tutorials/ai-services/openvidu-live-captions/index.md) for a complete example.
