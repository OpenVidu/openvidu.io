...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.7.0/application-client/openvidu-js)
...
[index.html](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-js/src/index.html#L32)
...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-js/src/app.js#L1-L28)
...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-js/src/app.js#L30-L78)
...
1. Event handling is configured for different scenarios within the room. These events are fired when new tracks are subscribed to and when existing tracks are unsubscribed.
   ...
   [app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-js/src/app.js#L80-L93)
   ...
   [app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-js/src/app.js#L122-L142)
   ...
   [app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-js/src/app.js#L144-L147)
...
1. It requests a token from the application server using the room name and participant name. This is done by calling the `getToken()` function:
   ...
   [app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-js/src/app.js#L156-L188)
...
[app.js](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-js/src/app.js#L95-L113)
