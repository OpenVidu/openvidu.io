...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.7.0/application-client/openvidu-ionic)
...
[app.component.ts](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-ionic/src/app/app.component.ts#L33-L123)
...
[app.component.ts](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-ionic/src/app/app.component.ts#L131-L180)
...
1. Event handling is configured for different scenarios within the room. These events are fired when new tracks are subscribed to and when existing tracks are unsubscribed.
   ...
   >
   > You can take a look at all the events in the [Livekit Documentation](https://docs.livekit.io/reference/client-sdk-js/enums/RoomEvent.html)
...
1. It requests a token from the application server using the room name and participant name. This is done by calling the `getToken()` method:
   ...
   [app.component.ts](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-ionic/src/app/app.component.ts#L197-L215)
...
[app.component.html](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-ionic/src/app/app.component.html#L108-L125)
...
[video.component.ts](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-ionic/src/app/video/video.component.ts#L4-L27)
...
[audio.component.ts](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-ionic/src/app/audio/audio.component.ts#L4-L25)
...
[app.component.ts](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-ionic/src/app/app.component.ts#L182-L195)
...
[AndroidManifest.xml](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-ionic/android/app/src/main/AndroidManifest.xml#L41-L43)
...
[Info.plist](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-client/openvidu-ionic/ios/App/App/Info.plist#L48-L51)
