...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.7.0/application-server/php)
...
[index.php](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-server/php/index.php#L1-L17)
...
[index.php](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-server/php/index.php#L19-L43)
...
[index.php](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.7.0/application-server/php/index.php#L45-L62)
