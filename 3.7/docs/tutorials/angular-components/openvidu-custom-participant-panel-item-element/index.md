...
[Source code](https://github.com/OpenVidu/openvidu-tutorials/tree/3.7.0/openvidu-components-angular/openvidu-custom-participant-panel-item-elements)
...
1. `leaveSession` method that disconnects the client from the OpenVidu Room.
