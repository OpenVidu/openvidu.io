...
[Source code](https://github.com/OpenVidu/openvidu-tutorials/tree/3.7.0/openvidu-components-angular/openvidu-additional-panels)
...
This tutorial combines the use of the **ToolbarAdditionalPanelButtonsDirective** and the **AdditionalPanelsDirective** to add new buttons to the toolbar and new panels to the videoconference. If you want to learn how to add new buttons to the toolbar, you can check the [openvidu-toolbar-panel-buttons](https://openvidu.io/3.7/docs/tutorials/angular-components/openvidu-toolbar-panel-buttons/index.md) tutorial.
...
git clone https://github.com/OpenVidu/openvidu-tutorials.git -b 3.7.0
```
...
- `main.ts`: This file defines the root application component. It imports the `OpenViduComponentsModule`, where we configure the [OpenVidu Components Angular](https://openvidu.io/3.7/docs/reference-docs/openvidu-components-angular/index.md) library.
...
1. `showExternalPanel`: Flag to control the visibility of the first external panel.
1. `showExternalPanel2`: Flag to control the visibility of the second external panel.
1. `subscribeToPanelToggling` method that subscribes to panel toggling events.
1. `onTokenRequested` method that fires when the VideoconferenceComponent requests a token to connect to the OpenVidu Room.
1. `panelService.panelStatusObs` observable that listens to panel toggling events.
1. `toggleMyPanel` method that toggles the visibility of external panels.
