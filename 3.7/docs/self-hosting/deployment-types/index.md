...
| **Installation instructions** | [Install](https://openvidu.io/3.7/docs/self-hosting/local/index.md)                                                                                                   | [Install](https://openvidu.io/3.7/docs/self-hosting/single-node/index.md)                                                                                                        | [Install](https://openvidu.io/3.7/docs/self-hosting/elastic/index.md)                                         | [Install](https://openvidu.io/3.7/docs/self-hosting/ha/index.md)         |
...
| **Egress Server**              | Module used to export media from a Room (for example, recordings or RTMP broadcasting). See [Egress](https://docs.livekit.io/transport/media/ingress-egress/egress/) .  |
| **Ingress Server**             | Module used to import media into a Room (for example, an MP4 video or an RTSP stream). See [Ingress](https://docs.livekit.io/transport/media/ingress-egress/ingress/) . |
| **Agents**                     | Modules used to add AI capabilities to Rooms. See [AI Services](https://openvidu.io/3.7/docs/ai/overview/index.md).                                                     |
