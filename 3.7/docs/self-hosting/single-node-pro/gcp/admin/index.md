...
1. There, you will find the Virtual Machine that runs OpenVidu. Its name should be something like `<STACK_NAME>-vm-pro`. Click on it.
...
Regarding the administration of your deployment, you can follow the instructions in section [On Premises Single Node PRO Administration](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/admin/index.md).
...
1. Go to the Instance resource of OpenVidu and click on [*Stop*](#stop-openvidu-single-node-pro) -> [*Start*](#start-openvidu-single-node-pro) to apply the changes to the OpenVidu Single Node PRO deployment.
