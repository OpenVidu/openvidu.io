...
The [minimum inbound ports to allow](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/install/#port-rules) must be included in the security list rules.
...
1. Follow the [On-Premises install instructions](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/install/index.md) to install OpenVidu PRO on the instance.
...
- For administration of this OpenVidu Single Node PRO deployment, see the [Administration](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/oracle/admin/index.md) section.
- To upgrade OpenVidu, see the [Upgrade](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/oracle/upgrade/index.md) section.
...
1. Copy **`terraform.tfvars.example`** to **`terraform.tfvars`**, update the required parameters with your values, and adjust any optional defaults as needed.
   ...
   > | `openviduLicense`  | OpenVidu PRO license key. Visit <https://openvidu.io/account> to obtain your license.         |
   >
   > #### Optional Parameters
   >
...
1. If everything appears to be in order, check the [status](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/admin/#checking-the-status-of-services) and [logs](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/admin/#checking-logs) of the installed OpenVidu services.

### Configuration and administration

Once **OPENVIDU_URL** is reachable, the deployment is complete and working. See the [Administration](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/oracle/admin/index.md) section to learn how to manage your deployment.
