...
This section contains instructions for deploying a production-ready OpenVidu Single Node PRO deployment on Azure. The deployed services are the same as in the [On Premises Single Node PRO installation](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/install/index.md), but the process is automated through ARM Template Specs.
