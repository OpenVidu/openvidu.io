...
The [minimum inbound ports to allow](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/install/#port-rules) must be included in the Firewall rules.
...
1. Follow the [On-Premises install instructions](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/install/#guided-installation) to install OpenVidu on the instance.

______________________________________________________________________

### 4. Administration and upgrade

- For administration of this OpenVidu Single Node PRO deployment, see the [On-Premises administration section](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/admin/index.md).
- To upgrade OpenVidu, see the [On-Premises upgrade section](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/upgrade/index.md).
...
1. If everything seems fine, check the [status](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/admin/#checking-the-status-of-services) and the [logs](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/on-premises/admin/#checking-logs) of the installed OpenVidu services.

### Configuration and administration

When your **OPENVIDU_URL** is reachable, it means that everything has gone well. Now you can check the [Administration](https://openvidu.io/3.7/docs/self-hosting/single-node-pro/digitalocean/admin/index.md) section to learn how to manage your deployment.
