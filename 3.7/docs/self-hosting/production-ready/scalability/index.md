...
For AI agents the allocation strategy varies depending if the Agent is an [**OpenVidu agent**](https://openvidu.io/3.7/docs/ai/openvidu-agents/overview/index.md) or a [**custom agent**](https://openvidu.io/3.7/docs/ai/custom-agents/).
...
- When developing a [**custom agent**](https://openvidu.io/3.7/docs/ai/custom-agents/): the agent will be available to process a new request if its load does not exceed a specific threshold. Both the load metric and its threshold have the same defaults as for OpenVidu agents (average CPU load must be below 70%), but you can customize them in the `WorkerOptions` when developing your agent:
...
- [OpenVidu Elastic in AWS](https://openvidu.io/3.7/docs/self-hosting/elastic/aws/install/)
- [OpenVidu High Availability in AWS](https://openvidu.io/3.7/docs/self-hosting/ha/aws/install/)
...
- [OpenVidu Elastic in Azure](https://openvidu.io/3.7/docs/self-hosting/elastic/azure/install/)
- [OpenVidu High Availability in Azure](https://openvidu.io/3.7/docs/self-hosting/ha/azure/install/)
...
- [OpenVidu Elastic in GCP](https://openvidu.io/3.7/docs/self-hosting/elastic/gcp/install/)
- [OpenVidu High Availability in GCP](https://openvidu.io/3.7/docs/self-hosting/ha/gcp/install/)
...
- [OpenVidu Elastic in DigitalOcean](https://openvidu.io/3.7/docs/self-hosting/elastic/digitalocean/install/)
- [OpenVidu High Availability in DigitalOcean](https://openvidu.io/3.7/docs/self-hosting/ha/digitalocean/install/)
...
- [OpenVidu Elastic in Oracle Cloud Infrastructure](https://openvidu.io/3.7/docs/self-hosting/elastic/oracle/install/)
- [OpenVidu High Availability in Oracle Cloud Infrastructure](https://openvidu.io/3.7/docs/self-hosting/ha/oracle/install/)
