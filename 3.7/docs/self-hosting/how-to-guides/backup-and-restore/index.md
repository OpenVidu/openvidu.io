...
1. **Check that the following parameters are correctly configured**:
   ...
   **Elastic**
   ...
   - In case you need to reinstall Media Nodes, follow [this command](https://openvidu.io/3.7/docs/self-hosting/elastic/on-premises/install/#non-interactive-installation)
   ...
   **High Availability**
   ...
   - In case you need to reinstall Media Nodes, follow [this command](https://openvidu.io/3.7/docs/self-hosting/ha/on-premises/install-dlb/#non-interactive-installation)
...
1. **In AWS, Azure, or GCP deployments**: If you followed [Method 1](#method-1-direct-snapshots-of-openvidu-nodes-via-your-infrastructure-provider), ensure that the restored VMs have the correct security groups, IAM roles, and network configurations.
