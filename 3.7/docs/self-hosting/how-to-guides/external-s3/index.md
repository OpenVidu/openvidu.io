...
- [Config Troubleshooting](https://openvidu.io/3.7/docs/self-hosting/configuration/changing-config/#troubleshooting-configuration)
- The Status and Checking Logs sections under Administration for each deployment type:
  - [Single Node](https://openvidu.io/3.7/docs/self-hosting/single-node/on-premises/admin/#checking-the-status-of-services)
  - [Elastic](https://openvidu.io/3.7/docs/self-hosting/elastic/on-premises/admin/#checking-the-status-of-services)
  - [High Availability](https://openvidu.io/3.7/docs/self-hosting/ha/on-premises/admin/#checking-the-status-of-services)
