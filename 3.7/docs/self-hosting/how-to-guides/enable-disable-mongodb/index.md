...
1. Set the value of `MONGO_ENABLED` depending on the behavior you want:
   ...
   If you want to use an external MongoDB, check the [Configure an external MongoDB](https://openvidu.io/3.7/docs/self-hosting/how-to-guides/external-mongodb/index.md) guide for more details.
