...
In Azure environments, we recommend upgrading by redeploying the [OpenVidu High Availability Azure](https://openvidu.io/3.7/docs/self-hosting/ha/azure/install/index.md) stack using the latest version. This approach ensures that all components are updated accurately and consistently, as Azure templates and related configurations may vary between releases. Redeploying guarantees that all necessary changes are properly applied.
