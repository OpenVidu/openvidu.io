...
In Google Cloud Platform environments, we recommend upgrading by redeploying the [OpenVidu High Availability Google Cloud Platform](https://openvidu.io/3.7/docs/self-hosting/ha/gcp/install/index.md) stack using the latest version. This approach ensures that all components are updated accurately and consistently, as Google Cloud Platform terraform files and related configurations may vary between releases. Redeploying guarantees that all necessary changes are properly applied.
