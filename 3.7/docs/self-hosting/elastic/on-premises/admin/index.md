...
To add a new Media Node, simply spin up a new VM and run the OpenVidu installer script to integrate it into the existing cluster. Run the [installation command](https://openvidu.io/3.7/docs/self-hosting/elastic/on-premises/install/#media-node) on the new Media Node.
...
You can check how to change the configuration in the [Changing Configuration](https://openvidu.io/3.7/docs/self-hosting/configuration/changing-config/index.md) section. Also, there are multiple guides in the [How to Guides](https://openvidu.io/3.7/docs/self-hosting/how-to-guides/index.md) section that can help you with specific configuration changes.
