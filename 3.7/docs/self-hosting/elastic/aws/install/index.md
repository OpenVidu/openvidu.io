...
This section contains instructions for deploying a production-ready OpenVidu Elastic deployment on AWS. The deployed services are the same as in the [On Premises Elastic installation](https://openvidu.io/3.7/docs/self-hosting/elastic/on-premises/install/index.md), but the process is automated through AWS CloudFormation.
...
1. If everything seems fine, check the [status](https://openvidu.io/3.7/docs/self-hosting/elastic/on-premises/admin/#checking-the-status-of-services) and the [logs](https://openvidu.io/3.7/docs/self-hosting/elastic/on-premises/admin/#checking-logs) of the installed OpenVidu services in the Master Node and Media Nodes.

## Configuration and administration

When your CloudFormation stack reaches the **`CREATE_COMPLETE`** status, your OpenVidu Elastic deployment is ready to use. You can check the [Administration](https://openvidu.io/3.7/docs/self-hosting/elastic/aws/admin/index.md) section to learn how to manage your OpenVidu Elastic deployment.
