...
For DigitalOcean environments, we recommend upgrading by redeploying the [OpenVidu Elastic DigitalOcean](https://openvidu.io/3.7/docs/self-hosting/elastic/digitalocean/install/index.md) stack using the latest version. This approach ensures that all components are updated accurately and consistently, since DigitalOcean Terraform files and related configurations may differ between releases. Redeploying guarantees that all necessary changes are properly applied.
