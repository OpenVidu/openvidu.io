...
This section describes how to deploy a production-ready OpenVidu Elastic instance on Google Cloud Platform. The deployed services are identical to those in the [On Premises Elastic installation](https://openvidu.io/3.7/docs/self-hosting/elastic/on-premises/install/index.md), but are provisioned as Google Cloud Platform resources and can be automated through the Google Cloud Console.
...
- For the **Git ref**, use `v3.7.0`, corresponding to the version you want to deploy.
...
For more details, you can check the [variables.tf](https://github.com/OpenVidu/openvidu/blob/master/openvidu-deployment/pro/elastic/gcp/variables.tf) file to see additional information about the inputs.
...
1. Click on the secret of your choice, choose the last version and then click on the *"3 dots"* -> *"View secret value"* to retrieve that secret.
