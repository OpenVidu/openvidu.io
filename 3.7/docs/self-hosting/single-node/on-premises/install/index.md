...
- In the argument `--enabled-modules`, you can enable the modules you want to deploy. You can enable `openviduMeet` [OpenVidu Meet service](https://openvidu.io/3.7/meet/index.md) and `observability` (Grafana stack).
...
Once you have OpenVidu deployed, you can check the [Administration](https://openvidu.io/3.7/docs/self-hosting/single-node/on-premises/admin/index.md) section to learn how to manage your OpenVidu Single Node deployment.
