...
- Fill the **Git directory** with the following path `openvidu-deployment/community/singlenode/gcp`
...
For more details, you can check the [variables.tf](https://github.com/OpenVidu/openvidu/blob/master/openvidu-deployment/community/singlenode/gcp/variables.tf) file to see additional information about the inputs.
