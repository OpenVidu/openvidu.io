...
For administration, you can follow the instructions from the [On Premises Single Node Administration](https://openvidu.io/3.7/docs/self-hosting/single-node/on-premises/admin/index.md) section.
...
1. In the *"Outputs"* tab, click the Link at *"ServicesAndCredentials"*. This will open the AWS Secrets Manager which contains all the configurations of the OpenVidu Single Node deployment.
...
1. Go to the EC2 Console and click on *"Reboot instance"* to apply the changes to the Master Node.
