...
Room members can be created via the [REST API](https://openvidu.io/3.7/meet/embedded/reference/api.html#/operations/addRoomMember) . When creating a member, you specify:
...
- **List all members**: [GET /rooms/:roomId/members](https://openvidu.io/3.7/meet/embedded/reference/api.html#/operations/getRoomMembers)
- **Retrieve member information**: [GET /rooms/:roomId/members/:memberId](https://openvidu.io/3.7/meet/embedded/reference/api.html#/operations/getRoomMember)
- **Update member permissions**: [PATCH /rooms/:roomId/members/:memberId](https://openvidu.io/3.7/meet/embedded/reference/api.html#/operations/updateRoomMember)
- **Delete a member**: [DELETE /rooms/:roomId/members/:memberId](https://openvidu.io/3.7/meet/embedded/reference/api.html#/operations/deleteRoomMember)
