...
OpenVidu Meet provides multiple **recording layout options** that can be configured when [creating a new room](https://openvidu.io/3.7/meet/features/rooms/creation-management/#create-rooms). These layouts determine how participants appear in the meeting recording, allowing you to choose the most suitable format for presentations, webinars, or collaborative sessions.
