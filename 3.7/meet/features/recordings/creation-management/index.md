...
Recordings must be started by a participant with the `canRecord` permission in the meeting view (see [Role Management](https://openvidu.io/3.7/meet/features/meetings/role-management/index.md)).
...
Recordings can also be **downloaded** from the recording view and from the "Recordings" page, as well as from the [REST API](https://openvidu.io/3.7/meet/features/recordings/creation-management/index.md#recording-rest-api).

## Delete Recordings

Recordings can be deleted individually or in bulk from the "Recordings" page in OpenVidu Meet console, as well as from the recording view (if the user has the required permissions). Recordings can also be deleted through the [REST API](https://openvidu.io/3.7/meet/features/recordings/creation-management/index.md#recording-rest-api).
