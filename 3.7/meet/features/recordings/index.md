...
Recordings must be started by a participant with role "Moderator" in the meeting view (see [Participant roles in a room](https://openvidu.io/3.7/meet/features/users-and-permissions/#participant-roles-in-a-room)).

\[[](../../../assets/videos/meet/start-recording.mp4)\](https://openvidu.io/3.7/assets/videos/meet/start-recording.mp4)
...
\[[](../../../assets/videos/meet/recording-while-meeting.mp4)\](https://openvidu.io/3.7/assets/videos/meet/recording-while-meeting.mp4)
...
- Users can generate a shareable link from the recording list.
  ...
  \[[](../../../assets/videos/meet/share-recording-from-recording-list.mp4)\](https://openvidu.io/3.7/assets/videos/meet/share-recording-from-recording-list.mp4)

- Users can generate a shareable link from the recording view.

  \[[](../../../assets/videos/meet/share-recording.mp4)\](https://openvidu.io/3.7/assets/videos/meet/share-recording.mp4)

- From OpenVidu Meet console it is possible to generate shareable links for any recording.

  \[[](../../../assets/videos/meet/meet-recording-share-dark.mp4)\](https://openvidu.io/3.7/assets/videos/meet/meet-recording-share-dark.mp4)

## Room recording settings

Rooms can be configured with different recording settings. You can set up these settings when [creating a new room](https://openvidu.io/3.7/meet/features/rooms-and-meetings/#creating-a-room) or [editing an existing room](https://openvidu.io/3.7/meet/features/rooms-and-meetings/#editing-a-room).
