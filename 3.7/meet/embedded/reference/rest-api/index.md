...
- `/api/v1/rooms`: manage [rooms](https://openvidu.io/3.7/meet/features/rooms-and-meetings/index.md).
- `/api/v1/recordings`: manage [recordings](https://openvidu.io/3.7/meet/features/recordings/index.md).
