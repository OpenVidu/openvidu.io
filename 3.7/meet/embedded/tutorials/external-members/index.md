...
This tutorial extends the [basic OpenVidu Meet WebComponent tutorial](https://openvidu.io/3.7/meet/embedded/tutorials/webcomponent/index.md) to show how to add **external members** to an OpenVidu Meet room.
...
The application uses the [OpenVidu Meet API](https://openvidu.io/3.7/meet/embedded/reference/rest-api/index.md) to manage rooms and room members, and the [OpenVidu Meet WebComponent](https://openvidu.io/3.7/meet/embedded/reference/webcomponent/index.md) to embed the meeting.

Registered vs. external members

Room members can be either **registered members** (real OpenVidu Meet users, covered in the [Registered Members tutorial](https://openvidu.io/3.7/meet/embedded/tutorials/registered-members/index.md)) or **external members**. Registered members share the room's authenticated access URL and log in with their credentials; external members instead receive a **unique** access link that requires no authentication. See [Room Access](https://openvidu.io/3.7/meet/features/rooms/access/#room-members) for the full picture.
...
This tutorial builds upon the [basic OpenVidu Meet WebComponent tutorial](https://openvidu.io/3.7/meet/embedded/tutorials/webcomponent/index.md), adding external member management. We'll focus on the new features and modifications related to external members.
...
You can fine-tune the member's permissions beyond the base role by including a `customPermissions` object in the request. See the [`addRoomMember` operation](https://openvidu.io/3.7/meet/embedded/reference/api.html#/operations/addRoomMember) in the REST API reference for the full list of permissions.
