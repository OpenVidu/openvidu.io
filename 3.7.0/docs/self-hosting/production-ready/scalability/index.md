...
Right now, there is no autoscaling in DigitalOcean, but you can configure the average number of nodes you want. To find out how, follow the steps of [Configurate Number of Fixed Media Nodes OpenVidu Elastic](https://openvidu.io/3.7.0/docs/self-hosting/elastic/digitalocean/admin/#change-fixed-number-of-media-nodes) or [Configurate Number of Fixed Media Nodes OpenVidu High Availability](https://openvidu.io/3.7.0/docs/self-hosting/ha/digitalocean/admin/#change-fixed-number-of-media-nodes) depending on your deployment.
