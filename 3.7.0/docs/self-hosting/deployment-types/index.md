...
| **Installation instructions** | [Install](https://openvidu.io/3.7.0/docs/self-hosting/local/index.md)                                                                                                 | [Install](https://openvidu.io/3.7.0/docs/self-hosting/single-node/index.md)                                                                                                      | [Install](https://openvidu.io/3.7.0/docs/self-hosting/elastic/index.md)                                       | [Install](https://openvidu.io/3.7.0/docs/self-hosting/ha/index.md)       |
...
| SERVICE                                                      | DESCRIPTION                                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[OpenVidu Meet](https://openvidu.io/3.7.0/meet/index.md)** | A high-quality video calling service based on OpenVidu.                                                                                                                                                                                                                                   |
...
| **Agents**                     | Modules used to add AI capabilities to Rooms. See [AI Services](https://openvidu.io/3.7.0/docs/ai/overview/index.md).                                  |
