...
- Access recordings.
- Share room links with different permissions (see [Users and permissions](https://openvidu.io/3.7.0/meet/features/users-and-permissions/index.md)).
...
Each room has different room links, each one granting access to the room with a specific participant role. See [Participant roles in a meeting](https://openvidu.io/3.7.0/meet/features/users-and-permissions/#participant-roles-in-a-meeting) for more information.
...
Every possible action against a room can be done through [OpenVidu Meet REST API](https://openvidu.io/3.7.0/meet/embedded/reference/rest-api/index.md):
...
Recordings can also be accessed from the "Recordings" page in OpenVidu Meet, even after the meeting has ended. See [Managing recordings](https://openvidu.io/3.7.0/meet/features/recordings/#managing-recordings).
