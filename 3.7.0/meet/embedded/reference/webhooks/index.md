...
Visit [OpenVidu Meet Webhooks](https://openvidu.io/3.7.0/meet/embedded/reference/api.html#/webhooks/recordingStartedWebhook) reference documentation for a complete list of all available webhook events. They include:

- [`meetingStarted`](https://openvidu.io/3.7.0/meet/embedded/reference/api.html#/webhooks/meetingStartedWebhook)
- [`meetingEnded`](https://openvidu.io/3.7.0/meet/embedded/reference/api.html#/webhooks/meetingEndedWebhook)
- [`recordingStarted`](https://openvidu.io/3.7.0/meet/embedded/reference/api.html#/webhooks/recordingStartedWebhook)
- [`recordingUpdated`](https://openvidu.io/3.7.0/meet/embedded/reference/api.html#/webhooks/recordingUpdatedWebhook)
- [`recordingEnded`](https://openvidu.io/3.7.0/meet/embedded/reference/api.html#/webhooks/recordingEndedWebhook)
