...
The application uses the [OpenVidu Meet API](https://openvidu.io/3.4/meet/embedded/reference/rest-api/index.md) to create and delete rooms, and direct links to the **OpenVidu Meet interface** to access the video call functionality.
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/src/index.js#L1-L23)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/src/index.js#L25-L58)
...
1. A new room is created using the OpenVidu Meet API by sending a `POST` request to the `rooms` endpoint. The request includes the room name and additional configuration options (with default values):
   ...
   > **Info**
   >
   > The reference for the room configuration options can be found in the [OpenVidu Meet REST API reference](https://openvidu.io/3.4/meet/assets/htmls/rest-api.html#/operations/createRoom) .

   To send requests to the OpenVidu Meet API, we use the `httpRequest` function:

   [index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/src/index.js#L89-L111)
...
1. If the room is successfully created, the server returns a `201 Created` response with the room object. Otherwise, the error is handled by the `handleApiError` function, which logs the error and returns an appropriate HTTP response:
   ...
   [index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/src/index.js#L113-L119)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/src/index.js#L60-L69)
...
[index.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/src/index.js#L71-L82)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/public/js/app.js#L1-L23)
...
1. Makes a `GET` request to the `/rooms` endpoint to fetch the list of rooms.
   ...
   [app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/public/js/app.js#L117-L134)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/public/js/app.js#L25-L75)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/public/js/app.js#L77-L103)
...
[app.js](https://github.com/OpenVidu/openvidu-meet-tutorials/blob/3.4.1/meet-direct-link/public/js/app.js#L105-L115)
