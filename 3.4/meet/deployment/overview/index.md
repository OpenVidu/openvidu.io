...
It is important to mention that when we talk about self-hosting OpenVidu, we don't just mean installing it in bare-metal servers or private VPCs. OpenVidu also supports deployments in the most popular cloud providers, using their native services when possible. **AWS** and **Azure** are currently supported, and others are coming soon. You can learn more about the different options to deploy OpenVidu in the [deployment types](https://openvidu.io/3.4/docs/self-hosting/deployment-types/index.md) section.
...
- **Performance**
  ...
  [Learn more about performance](https://openvidu.io/3.4/docs/self-hosting/production-ready/performance/index.md)
...
- **Scalability**
  ...
  [Learn more about scalability](https://openvidu.io/3.4/docs/self-hosting/production-ready/scalability/index.md)
...
- **Fault Tolerance**
  ...
  [Learn more about fault tolerance](https://openvidu.io/3.4/docs/self-hosting/production-ready/fault-tolerance/index.md)
...
- **Observability**
  ...
  [Learn more about observability](https://openvidu.io/3.4/docs/self-hosting/production-ready/observability/index.md)
...
- [Local deployment](https://openvidu.io/3.4/meet/deployment/local/index.md), to test and develop in your machine.
- [Basic deployment](https://openvidu.io/3.4/meet/deployment/basic/index.md), a production installation requiring a single server.
- [Advanced deployments](https://openvidu.io/3.4/meet/deployment/advanced/index.md), a production installation requiring multiple servers for scalability and high-availability.
...
| **Installation instructions** | [Try](https://openvidu.io/3.4/meet/deployment/local/index.md) | [Install](https://openvidu.io/3.4/meet/deployment/basic/index.md) | [Install](https://openvidu.io/3.4/meet/deployment/advanced/index.md)                                                                          |
