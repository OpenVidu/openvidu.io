...
- Users request a LiveKit token to any [application server](https://openvidu.io/3.4/docs/tutorials/application-server/index.md) to connect to a room.
...
- All of them are compatible with any [application server](https://openvidu.io/3.4/docs/tutorials/application-server/index.md), meaning that they can request a LiveKit token from any of the server applications.
