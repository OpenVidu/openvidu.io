...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.4.1/application-client/openvidu-android)

This tutorial is a simple video-call application built for **Android**, using **Kotlin**, that allows:

- Joining a video call room by requesting a token from any [application server](https://openvidu.io/3.4/docs/tutorials/application-server/index.md).
...
To use a production-ready OpenVidu deployment, visit the official [deployment guide](https://openvidu.io/3.4/docs/self-hosting/deployment-types/index.md).
...
For more information, check the [Node.js tutorial](https://openvidu.io/3.4/docs/tutorials/application-server/node/index.md).
...
For more information, check the [Go tutorial](https://openvidu.io/3.4/docs/tutorials/application-server/go/index.md).
...
For more information, check the [Ruby tutorial](https://openvidu.io/3.4/docs/tutorials/application-server/ruby/index.md).
...
For more information, check the [Java tutorial](https://openvidu.io/3.4/docs/tutorials/application-server/java/index.md).
...
For more information, check the [Python tutorial](https://openvidu.io/3.4/docs/tutorials/application-server/python/index.md).
...
For more information, check the [Rust tutorial](https://openvidu.io/3.4/docs/tutorials/application-server/rust/index.md).
...
For more information, check the [PHP tutorial](https://openvidu.io/3.4/docs/tutorials/application-server/php/index.md).
...
For more information, check the [.NET tutorial](https://openvidu.io/3.4/docs/tutorials/application-server/dotnet/index.md).
...
[build.gradle.kts](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/build.gradle.kts#L43)
...
[settings.gradle.kts](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/settings.gradle.kts#L19)
...
[AndroidManifest.xml](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/AndroidManifest.xml#L9-L12)
...
[RoomLayoutActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/RoomLayoutActivity.kt#L175-L208)
...
[ConfigureUrlsActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/ConfigureUrlsActivity.kt#L24-L35)
...
[MainActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/MainActivity.kt#L33-L49)
...
[RoomLayoutActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/RoomLayoutActivity.kt#L32-L50)
...
[RoomLayoutActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/RoomLayoutActivity.kt#L52-L69)
...
[RoomLayoutActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/RoomLayoutActivity.kt#L77-L134)
...
1. Event handling is configured for different scenarios within the room. These events are fired when new tracks are subscribed to and when existing tracks are unsubscribed.
   ...
   [RoomLayoutActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/RoomLayoutActivity.kt#L136-L144)
   ...
   [RoomLayoutActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/RoomLayoutActivity.kt#L146-L158)
...
1. It requests a token from the application server using the room name and participant name. This is done by calling the `getToken()` method:
   ...
   [RoomLayoutActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/RoomLayoutActivity.kt#L210-L229)
...
[ParticipantViewHolder.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/ParticipantViewHolder.kt#L12-L28)
...
[RoomLayoutActivity.kt](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-android/app/src/main/java/io/openvidu/android/RoomLayoutActivity.kt#L160-L173)
