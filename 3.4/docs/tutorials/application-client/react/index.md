...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.4.1/application-client/openvidu-react)
...
[App.tsx](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-react/src/App.tsx#L14-L51)
...
[App.tsx](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-react/src/App.tsx#L53-L89)
...
1. It requests a token from the application server using the room name and participant name. This is done by calling the `getToken()` function:
   ...
   [App.tsx](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-react/src/App.tsx#L101-L133)
...
[App.tsx](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-react/src/App.tsx#L187-L205)
...
[VideoComponent.tsx](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-react/src/components/VideoComponent.tsx#L5-L32)
...
[AudioComponent.tsx](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-react/src/components/AudioComponent.tsx#L4-L22)
...
[App.tsx](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.4.1/application-client/openvidu-react/src/App.tsx#L91-L99)
