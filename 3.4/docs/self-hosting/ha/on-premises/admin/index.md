...
To add a new Media Node, simply spin up a new VM and run the OpenVidu installer script to integrate it into the existing cluster. Run the [installation command](https://openvidu.io/3.4/docs/self-hosting/ha/on-premises/install-nlb/#media-node) on the new Media Node.
