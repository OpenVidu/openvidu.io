...
For administration, you can follow the instructions from the [On Premises Single Node Administration](https://openvidu.io/3.4/docs/self-hosting/single-node-pro/on-premises/admin/index.md) section.
