...
When your CloudFormation stack reaches the **`CREATE_COMPLETE`** status, your OpenVidu Single Node deployment is ready to use. You can check the [Administration](https://openvidu.io/3.4/docs/self-hosting/single-node/aws/admin/index.md) section to learn how to manage your deployment.
