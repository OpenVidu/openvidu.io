# OpenVidu Single Node COMMUNITY administration: Google Cloud Platform
...
1. Stop the instance if is not stopped. Wait for it to stop.

1. Click on *"Edit"*, go down and change the **Machine Type**.
