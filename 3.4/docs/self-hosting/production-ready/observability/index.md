...
OpenVidu brings everything you need to fulfill these requirements. We collect **events**, **metrics** and **logs** from your deployment and provide [**OpenVidu Dashboard**](https://openvidu.io/3.4/docs/self-hosting/production-ready/observability/openvidu-dashboard/index.md) and a [**Grafana stack**](https://openvidu.io/3.4/docs/self-hosting/production-ready/observability/grafana-stack/index.md) to navigate them.
