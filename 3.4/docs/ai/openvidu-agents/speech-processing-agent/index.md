...
- [**Live Captions**](https://openvidu.io/3.4/docs/ai/live-captions/): transcribe the audio tracks of your Rooms in real time with great accuracy and display the results as live captions in your frontend.
