...
- [**Live Captions**](https://openvidu.io/3.4/docs/ai/live-captions/index.md): transcribe the audio tracks of your Rooms in real time with great accuracy and display the results as live captions in your frontend.
...
- **Live Captions**: see [Live Captions service](https://openvidu.io/3.4/docs/ai/live-captions/#how-to-enable-live-captions-service-in-your-openvidu-deployment).
...
<a href='https://github.com/OpenVidu/openvidu-agents/blob/3.4.1/speech-processing/agent-speech-processing.yaml' target='_blank'>agent-speech-processing.yaml</a>
