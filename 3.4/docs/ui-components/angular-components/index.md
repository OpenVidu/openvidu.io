...
Using Angular Components in your application is straightforward. The official [Angular Components Tutorials](https://openvidu.io/3.4/docs/tutorials/angular-components/index.md) cover everything Angular Components offers, from customizing colors and branding logos to injecting new custom features.
...
- **Videoconference**
  ...
  [See Reference](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/VideoconferenceComponent.html)
...
- **Panel**
  ...
  [See Reference](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/PanelComponent.html)
...
[Toolbar](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/ToolbarComponent.html) [Layout](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/LayoutComponent.html) [Stream](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/StreamComponent.html) [ChatPanel](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/ChatPanelComponent.html) [ParticipantsPanel](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/ParticipantsPanelComponent.html) [ParticipantPanelItem](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/ParticipantPanelItemComponent.html) [ActivitiesPanel](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/ActivitiesPanelComponent.html) [RecordingActivity](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/RecordingActivityComponent.html) [BroadcastingActivity](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/BroadcastingActivityComponent.html) [AdminLogin](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/AdminLoginComponent.html) [AdminDashboard](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/components/AdminDashboardComponent.html)
...
- **Structural Directives**: These directives manipulate the DOM by adding or removing elements from the view.
  ...
  You can check the list of available structural directives in the [Angular Components API Reference](https://openvidu.io/3.4/docs/reference-docs/openvidu-components-angular/modules/OpenViduComponentsDirectiveModule.html).
...
A practical example showcases the potential of Angular Components is our production-ready flagship application, [**OpenVidu Meet**](https://openvidu.io/3.4/meet/index.md). This application is built using Angular Components and demonstrates the power and flexibility of the library.
