...
- **[OpenVidu Single Node PRO](https://openvidu.io/latest/docs/self-hosting/single-node/index.md)**: the same single-machine setup, with 2x performance using [Mediasoup](https://mediasoup.org/) and advanced observability.
