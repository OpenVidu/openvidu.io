...
1. **Horizontal Elastic Media Plane** — how to scale the part of the system that actually processes calls.
1. **High-Availability Control Plane** — how to stop a single failure from taking down the entire platform.
...
1. Compute per-node headroom and aggregate cluster capacity.
1. Trigger scale-out before saturation hits, not in response to it.
...
- [**Single Node**](https://openvidu.io/latest/docs/self-hosting/single-node/index.md) to launch quickly.
- [**Elastic**](https://openvidu.io/latest/docs/self-hosting/elastic/index.md) to scale media capacity dynamically.
- [**High Availability**](https://openvidu.io/latest/docs/self-hosting/ha/index.md) to meet strict enterprise resilience requirements.
...
If you're ready to move from MVP to production-grade infrastructure, the [OpenVidu documentation](https://openvidu.io/latest/docs/index.md) is the place to start.
