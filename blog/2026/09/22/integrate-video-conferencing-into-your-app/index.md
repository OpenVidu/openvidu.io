...
| **Product**        | [OpenVidu Meet](https://openvidu.io/latest/meet/index.md)                                            | [OpenVidu Platform](https://openvidu.io/latest/docs/index.md)           | [OpenVidu Platform](https://openvidu.io/latest/docs/index.md) |

None of this changes what you pay. Both products work in OpenVidu COMMUNITY and OpenVidu PRO, and the [pricing](https://openvidu.io/pricing/index.md) depends on the deployment, not on how you integrate.
...
This is the fastest path. OpenVidu Meet is a complete video conferencing application, and [OpenVidu Meet Embedded](https://openvidu.io/latest/meet/embedded/intro/index.md) puts that application inside yours. On the client you have three ways to show a room: a [direct link](https://openvidu.io/latest/meet/embedded/reference/direct-link/index.md), an [iframe](https://openvidu.io/latest/meet/embedded/reference/iframe/index.md) or the [`<openvidu-meet>` Web Component](https://openvidu.io/latest/meet/embedded/reference/webcomponent/index.md). On the server you have a [REST API](https://openvidu.io/latest/meet/embedded/reference/rest-api/index.md) to manage rooms, members, recordings and users, and [webhooks](https://openvidu.io/latest/meet/embedded/reference/webhooks/index.md) to react to what happens in them.
...
From there the element talks to your app in both directions, and you use it like any other element in your template. It emits [events](https://openvidu.io/latest/meet/embedded/reference/webcomponent/#events) when participants come and go, which you bind with the usual `(event)` syntax, and it accepts [commands](https://openvidu.io/latest/meet/embedded/reference/webcomponent/#commands) so your own buttons can drive the meeting, which you call through a `viewChild` reference:
...
The [Angular Components tutorials](https://openvidu.io/latest/docs/tutorials/angular-components/index.md) walk through each one of them separately, from a custom toolbar to a custom layout, custom streams, custom panels and an admin dashboard, and the [reference](https://openvidu.io/latest/docs/reference-docs/openvidu-components-angular/) lists every component, directive and CSS variable you can reach.
...
- **Level 2** in React means the [React Components](https://openvidu.io/latest/docs/ui-components/react-components/index.md) listed in our docs under UI Components. A `<LiveKitRoom>` with a `<VideoConference>` inside gets you a prebuilt meeting, and its hooks and contexts let you build your own.
- **Level 3** has tutorials for JavaScript, React, Angular, Vue, Electron, Ionic, Android and iOS on the client, and Node.js, Go, Ruby, Java, Python, Rust, PHP and .NET for the [token server](https://openvidu.io/latest/docs/tutorials/application-server/index.md). Any client works with any server.
...
You do not have to pick one level for the whole product either. Both products run on the same deployment, so a telehealth platform can embed OpenVidu Meet for consultations and use the SDKs for a one-way waiting-room stream. The [Meet vs Platform comparison](https://openvidu.io/openvidu-meet-vs-openvidu-platform/index.md) has the side-by-side table, and [OpenVidu Meet vs OpenVidu Platform in 2026](https://openvidu.io/blog/2026/06/16/meet-vs-platform/index.md) goes deeper into why we split the two products in the first place.
...
- [OpenVidu Meet Embedded step-by-step guide](https://openvidu.io/latest/meet/embedded/step-by-step-guide/index.md) and the progressive [Meet tutorials](https://openvidu.io/latest/meet/embedded/tutorials/index.md), from direct links to webhooks.
- [Angular Components tutorials](https://openvidu.io/latest/docs/tutorials/angular-components/index.md), one per customizable piece.
- [Build your app](https://openvidu.io/latest/docs/build-your-app/index.md) and the [Getting started](https://openvidu.io/latest/docs/getting-started/index.md) page for the SDK path.
- [Deployment types](https://openvidu.io/latest/docs/self-hosting/deployment-types/index.md) when you are ready to leave `localhost`: Single Node, Elastic or High Availability, on your servers or any major cloud.
