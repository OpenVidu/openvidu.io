...
1. Show/hide the hand-tracking skeleton (only in your own view)
1. Raise/lower the hand
...
**Repository:** [github.com/openvidu-labs/openvidu-ai-gestures](https://github.com/openvidu-labs/openvidu-ai-gestures)

You'll need [Node.js](https://nodejs.org/en/download) and Docker installed. Then:
...
If gesture control isn't what you need but self-hosting your own video infrastructure is, that's exactly what **[OpenVidu](https://openvidu.io/latest/docs/index.md)** is for: the same LiveKit-compatible core you just used, wrapped in a production-ready platform you can run anywhere, from a quick local Docker Compose install to a highly available cluster. The [self-hosting docs](https://openvidu.io/latest/docs/self-hosting/local/index.md) are the natural next step.
