...
- [**Five production-ready cloud deployments**](https://openvidu.io/latest/docs/self-hosting/deployment-types/index.md) to get you started in minutes on AWS, Azure, GCP, DigitalOcean or Oracle Cloud.
...
See the full methodology and numbers in [Performance](https://openvidu.io/latest/docs/self-hosting/production-ready/performance/index.md).
...
If you're weighing the underlying media engine rather than the platform, see [OpenVidu vs mediasoup](https://openvidu.io/openvidu-vs-mediasoup/index.md) for the equivalent honest account of when raw mediasoup is the right call.
