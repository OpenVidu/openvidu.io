...
Participants in a room can have different roles, which grant different permissions. The role of a participant is determined by the room link used to join. See [Room links](https://openvidu.io/3.5/meet/features/rooms-and-meetings/#room-links) for more information.
