...
- `/api/v1/rooms`: manage [rooms](https://openvidu.io/3.5/meet/features/rooms-and-meetings/index.md).
- `/api/v1/recordings`: manage [recordings](https://openvidu.io/3.5/meet/features/recordings/index.md).
...
\[[](../../../../assets/videos/meet/generate-api-key.mp4)\](https://openvidu.io/3.5/assets/videos/meet/generate-api-key.mp4)

## Reference

You can access the REST API reference documentation at:

- [**OpenVidu Meet REST API Reference**](https://openvidu.io/3.5/meet/embedded/reference/api.html)
...
\[[](../../../../assets/videos/meet/rest-api-test.mp4)\](https://openvidu.io/3.5/assets/videos/meet/rest-api-test.mp4)
