...
> All client side operations are exemplified using the [LiveKit JS Client SDK](https://docs.livekit.io/reference/client-sdk-js/modules.html) . For other client SDKs, refer to the corresponding LiveKit reference documentation.
...
> [Reference docs](https://docs.livekit.io/frontends/build/authentication/)
...
> [Reference docs](https://docs.livekit.io/intro/basics/connect/#connect-to-a-room)
...
> [Reference docs](https://docs.livekit.io/intro/basics/connect/#disconnect-from-a-room)
...
> [Reference docs](https://docs.livekit.io/transport/media/publish/)
...
> [Reference docs](https://docs.livekit.io/transport/media/publish/#Mute-and-unmute)
...
> [Reference docs](https://docs.livekit.io/reference/client-sdk-js/classes/LocalParticipant.html#unpublishTrack)
...
First of all, you can set Room metadata that will be available for all clients in the `Room` object. You do so in your application server when calling the [`CreateRoom` API](https://docs.livekit.io/reference/other/roomservice-api/#CreateRoom) (available for all LiveKit Server SDKs and the HTTP Server API). The Room metadata will be available in the client side like this:

```typescript
console.log(room.metadata);
```

You can update the Room metadata at any time from your application server with the [`UpdateRoomMetadata` API](https://docs.livekit.io/reference/other/roomservice-api/#UpdateRoomMetadata) (available for all LiveKit Server SDKs and the HTTP Server API). The client side will be notified of the change with the `roomMetadataChanged` event of the `Room` object:
...
Secondly, you can also set Participant metadata. You do so when creating an [access token](https://docs.livekit.io/frontends/build/authentication/) in your application server, setting `metadata` field of the JWT.

Participants can also update their own metadata from the client side, if their access token was created with [grant `canUpdateOwnMetadata`](https://docs.livekit.io/frontends/reference/tokens-grants/#video-grant) .
...
Finally, you can send messages to Participants in the Room using the [`LocalParticipant.publishData`](https://docs.livekit.io/reference/client-sdk-js/classes/LocalParticipant.html#publishData) method:
...
The [`DataPublishOptions`](https://docs.livekit.io/reference/client-sdk-js/types/DataPublishOptions.html) allow setting the reliability of the message (depending on the nature of the message it can be sent as a reliable or lossy message), a topic to easily filter messages, and the participants that will receive the message.
...
> [Reference docs](https://docs.livekit.io/transport/data/)
...
- [**RoomService**](https://docs.livekit.io/reference/other/roomservice-api/#RoomService-APIs) : to manage Rooms and Participants.
- [**Egress**](https://docs.livekit.io/reference/other/egress/api/) : to manage egress operations.
- [**Ingress**](https://docs.livekit.io/reference/other/ingress/api/) : to manage ingress operations.
...
You can also create custom screen tracks, for example capturing the audio of the screen and fine-tuning the video capture options (checkout the [ScreenTrackOptions](https://docs.livekit.io/reference/client-sdk-js/interfaces/ScreenShareCaptureOptions.html) interface for detailed information):
...
> [Reference docs](https://docs.livekit.io/transport/media/screenshare/)
...
> [Reference docs](https://docs.livekit.io/transport/media/ingress-egress/egress/)
...
> [Reference docs](https://docs.livekit.io/transport/media/ingress-egress/ingress/)

### IP Cameras

With OpenVidu you can ingest **RTSP** streams into your Rooms. To do so, simply use the [Ingress API](https://docs.livekit.io/transport/media/ingress-egress/ingress/) to create and ingress of input type `URL`, providing the IP camera RTSP URL as value:
...
1. Consume the Ingress API directly: [Reference Docs](https://docs.livekit.io/reference/other/ingress/api/)
...
Every application server tutorial here is ready to receive webhooks: [Application Server Tutorials](https://openvidu.io/3.5/docs/tutorials/application-server/index.md).

Visit the LiveKit reference documentation for a detailed explanation of each webhook event:

> [Reference docs](https://docs.livekit.io/intro/basics/rooms-participants-tracks/webhooks-events/)
