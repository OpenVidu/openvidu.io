...
[Enable the Speech Processing agent](https://openvidu.io/3.5/docs/ai/openvidu-agents/speech-processing-agent/#enable-the-agent-and-configure-ai-services)

You configure the Live Captions service by setting up the following properties when [modifying file `agent-speech-processing.yaml`](https://openvidu.io/3.5/docs/ai/openvidu-agents/speech-processing-agent/#2-modify-file-agent-speech-processingyaml):

[agent-speech-processing.yaml](https://github.com/OpenVidu/openvidu-agents/blob/3.5.0/speech-processing/agent-speech-processing.yaml)
...
| ----------- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
|             | `aws`          | Uses [Amazon Transcribe](https://aws.amazon.com/transcribe/)                                                                                                           |                 |
|             | `azure`        | Uses [Azure Speech service](https://learn.microsoft.com/azure/ai-services/speech-service/index-speech-to-text)                                                         |                 |
|             | `azure_openai` | Uses [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service/)                                                                            |                 |
|             | `google`       | Uses [Google Cloud Speech-to-Text](https://cloud.google.com/speech-to-text)                                                                                            |                 |
|             | `openai`       | Uses [OpenAI Speech to text](https://platform.openai.com/docs/guides/speech-to-text)                                                                                   |                 |
|             | `groq`         | Uses [Groq Speech](https://console.groq.com/docs/speech-to-text)                                                                                                       |                 |
|             | `deepgram`     | Uses [Deepgram Speech-to-Text API](https://deepgram.com/product/speech-to-text)                                                                                        |                 |
|             | `assemblyai`   | Uses [AssemblyAI Speech-to-Text API](https://www.assemblyai.com/products/speech-to-text)                                                                               |                 |
|             | `fal`          | Uses [Fal Speech-to-Text API](https://docs.fal.ai/guides/convert-speech-to-text/)                                                                                      |                 |
|             | `clova`        | Uses [Naver Clova Speech Recognition](https://api.ncloud-docs.com/docs/en/ai-naver-clovaspeechrecognition-stt) . Specialized in Japanese, Korean and Chinese languages |                 |
|             | `speechmatics` | Uses [Speechmatics Real-Time API](https://docs.speechmatics.com/introduction/rt-guide)                                                                                 |                 |
|             | `gladia`       | Uses [Gladia Speech-to-Text API](https://www.gladia.io/product/async-transcription)                                                                                    |                 |
|             | `sarvam`       | Uses [Sarvam Speech-to-Text API](https://docs.sarvam.ai/api-reference-docs/speech-to-text/transcribe) . Optimized for Indian languages                                 |                 |
|             | `mistralai`    | Uses [Voxtral](https://mistral.ai/news/voxtral)                                                                                                                        |                 |
|             | `cartesia`     | Uses [Cartesia Ink-Whisper](https://cartesia.ai/ink)                                                                                                                   |                 |
|             | `soniox`       | Uses [Soniox Speech-to-Text API](https://soniox.com/speech-to-text)                                                                                                    |                 |
...
Check out the [Live Captions tutorial](https://openvidu.io/3.5/docs/tutorials/ai-services/openvidu-live-captions/index.md) for a complete example.
