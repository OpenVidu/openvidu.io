...
This section contains the instructions to deploy a production-ready OpenVidu High Availability deployment in AWS. Deployed services are the same as the [On Premises High Availability installation](https://openvidu.io/3.5/docs/self-hosting/ha/on-premises/install-nlb/index.md) but automate the process with AWS CloudFormation.
...
For the **RTCEngine** parameter, you can choose between **Pion** (the default engine used by LiveKit) and **Mediasoup** (with a boost in performance). Learn more about the differences [here](https://openvidu.io/3.5/docs/self-hosting/production-ready/performance/index.md).
...
1. If everything seems fine, check the [status](https://openvidu.io/3.5/docs/self-hosting/ha/on-premises/admin/#checking-the-status-of-services) and the [logs](https://openvidu.io/3.5/docs/self-hosting/ha/on-premises/admin/#checking-logs) of the installed OpenVidu services in all the Master Nodes and Media Nodes.

## Configuration and administration

When your CloudFormation stack reaches the **`CREATE_COMPLETE`** status, your OpenVidu High Availability deployment is ready to use. You can check the [Administration](https://openvidu.io/3.5/docs/self-hosting/ha/aws/admin/index.md) section to learn how to manage your deployment.
