...
In Google Cloud Platform environments, we recommend upgrading by redeploying [OpenVidu High Availability Google Cloud Platform](https://openvidu.io/3.5/docs/self-hosting/ha/gcp/install/index.md) stack using the latest version. This approach ensures that all components are updated accurately and consistently, as Google Cloud Platform terrafrom files and related configurations may vary between releases. Redeploying guarantees that all necessary changes are properly applied.
