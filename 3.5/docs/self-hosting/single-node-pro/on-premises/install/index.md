...
This section contains the instructions to deploy a production-ready OpenVidu Single Node PRO deployment on-premises. It is a deployment based on Docker and Docker Compose, which will automatically configure all the necessary services for OpenVidu to work properly.
...
>    ```
>
> 1. Execute the following commands to add firewall rules are the following:
>
>    ```text
...
Once you have OpenVidu deployed, you can check the [Administration](https://openvidu.io/3.5/docs/self-hosting/single-node-pro/on-premises/admin/index.md) section to learn how to manage your OpenVidu Single Node deployment.
