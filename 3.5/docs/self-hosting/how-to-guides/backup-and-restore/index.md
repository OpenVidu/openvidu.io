...
1. **Check that the following parameters are correctly configured**:
   ...
   **Elastic**
   ...
   - In case you need to reinstall Media Nodes, follow [this command](https://openvidu.io/3.5/docs/self-hosting/elastic/on-premises/install/#non-interactive-installation)
   ...
   **High Availability**
   ...
   - In case you need to reinstall Media Nodes, follow [this command](https://openvidu.io/3.5/docs/self-hosting/ha/on-premises/install-dlb/#non-interactive-installation)
