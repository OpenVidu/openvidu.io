...
For administration, you can follow the instructions from the [On Premises Elastic Administration](https://openvidu.io/3.5/docs/self-hosting/elastic/on-premises/admin/index.md) section.
