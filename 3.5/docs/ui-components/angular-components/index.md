...
You can check out all component events in the [Angular Components API Reference](https://openvidu.io/3.5/docs/reference-docs/openvidu-components-angular/).
...
- [Angular Components API Reference](https://openvidu.io/3.5/docs/reference-docs/openvidu-components-angular/)
