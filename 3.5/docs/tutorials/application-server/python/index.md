...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.5.0/application-server/python)
...
[app.py](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.5.0/application-server/python/app.py#L1-L15)
...
[app.py](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.5.0/application-server/python/app.py#L18-L31)
...
[app.py](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.5.0/application-server/python/app.py#L34-L51)
