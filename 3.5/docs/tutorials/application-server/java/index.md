...
[Source code](https://github.com/OpenVidu/openvidu-livekit-tutorials/tree/3.5.0/application-server/java)

This is a minimal server application built for Java with [Spring Boot](https://spring.io/) that allows:

- Generating LiveKit tokens on demand for any [application client](https://openvidu.io/3.5/docs/tutorials/application-client/index.md).
...
For more information, check the [JavaScript tutorial](https://openvidu.io/3.5/docs/tutorials/application-client/javascript/index.md).
...
For more information, check the [React tutorial](https://openvidu.io/3.5/docs/tutorials/application-client/react/index.md).
...
For more information, check the [Angular tutorial](https://openvidu.io/3.5/docs/tutorials/application-client/angular/index.md).
...
For more information, check the [Vue tutorial](https://openvidu.io/3.5/docs/tutorials/application-client/vue/index.md).
...
>
> One advantage of [running OpenVidu locally](#run-openvidu-locally) is that you can test your application client with other devices in your local network very easily without worrying about SSL certificates. For more information, see section [Accessing your local deployment from other devices on your network](https://openvidu.io/3.5/docs/self-hosting/local/#accessing-your-local-deployment-from-other-devices-on-your-network).

For more information, check the [Electron tutorial](https://openvidu.io/3.5/docs/tutorials/application-client/electron/index.md).
...
1. Serve the application:
   ...
   **Mobile**
   ...
   If you run [OpenVidu locally](#run-openvidu-locally) you don't need to worry about this. OpenVidu will handle all of the above requirements for you. For more information, see section [Accessing your local deployment from other devices on your network](https://openvidu.io/3.5/docs/self-hosting/local/#accessing-your-local-deployment-from-other-devices-on-your-network).
...
For more information, check the [Ionic tutorial](https://openvidu.io/3.5/docs/tutorials/application-client/ionic/index.md).
...
For more information, check the [Android tutorial](https://openvidu.io/3.5/docs/tutorials/application-client/android/index.md).
...
For more information, check the [iOS tutorial](https://openvidu.io/3.5/docs/tutorials/application-client/ios/index.md).
...
[Controller.java](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.5.0/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L19-L27)
...
[Controller.java](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.5.0/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L33-L48)
...
[Controller.java](https://github.com/OpenVidu/openvidu-livekit-tutorials/blob/3.5.0/application-server/java/src/main/java/io/openvidu/basic/java/Controller.java#L50-L60)
