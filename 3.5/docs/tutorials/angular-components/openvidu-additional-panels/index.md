...
[Source code](https://github.com/OpenVidu/openvidu-tutorials/tree/3.5.0/openvidu-components-angular/openvidu-additional-panels)
...
This tutorial combines the use of the **ToolbarAdditionalPanelButtonsDirective** and the **AdditionalPanelsDirective** to add new buttons to the toolbar and new panels to the videoconference. If you want to learn how to add new buttons to the toolbar, you can check the [openvidu-toolbar-panel-buttons](https://openvidu.io/3.5/docs/tutorials/angular-components/openvidu-toolbar-panel-buttons/index.md) tutorial.
...
- `main.ts`: This file defines the root application component. It imports the `OpenViduComponentsModule`, where we configure the [OpenVidu Components Angular](https://openvidu.io/3.5/docs/reference-docs/openvidu-components-angular/index.md) library.
